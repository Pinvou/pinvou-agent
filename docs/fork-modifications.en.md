...
> Updated: 2026-08-18. Canonical Chinese register: [`docs/fork-modifications.md`](fork-modifications.md).
...
| Published status | `pinvou3-clean` and `pinvou-v0.9.5-r7` remain at `a36e6cd533024cfe5724bae21875aea42b2ed87a`; the PinvouOS feature parent gitlink pins `3f64e41e971167aede9390dbecc0a307224562ba`; `r1` through `r7` remain immutable historical tags |
...
- All 26 CodeWhale `forkguard_*` tests pass: 23 from the published r7 baseline plus three direct-round catalog and hard-admission tests in the PinvouOS feature checkpoint.
