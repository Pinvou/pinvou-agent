...
| Publication | Public `pinvou3-clean` has advanced to `92427bd8d` (including #58–#61); the immutable tag `pinvou-v0.9.12-r1` stays pinned at `1fafee7e2`; on this branch the parent gitlink points to the workspace_roots topic head `9abaa87e6` (CodeWhale PR #54 head, to be realigned after it merges) |
