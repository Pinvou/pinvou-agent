...
| Candidate branch | Pushed as `codex/pinvou-v0.9.12-r1` in CodeWhale PR #44, currently at `ff299f94b0795180c76d0336152385dbd02dfa05` |
...
| History | Eight signed commits above upstream, grouped into four long-lived topics; the final three commits close review-confirmed behavior, test, and documentation gaps |
| Drift | 72 files, `+4848/-637` (net +4,211), down from r13's 110 files and `+10895/-1195` |
| Guard | 36 distinct CodeWhale `forkguard_*` behavior tests (30 default plus 6 under `benchmark-eval-controls`) plus parent fingerprints/tests |
