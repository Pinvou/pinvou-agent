...
## Current state (2026-09-18: r1 baseline plus 21 registered commits, r2 tag pending)
...
| Drift | 180 files, `+13634/-1592` (net +12,042); r1 was 94 files `+5022/-944`, old r13 was 110 files `+10895/-1195` |
| Guard | 90 distinct CodeWhale `forkguard_*` behavior names (registered floor 54, six of them pinned behind the `benchmark-eval-controls` gate) plus parent fingerprints/tests; consumer PRs #396 (execpolicy), #408 (turn-bound cancel), #444 (swarm), #468 (computer-use), #472 (one-click export) depend on this batch |
