...
- CodeWhale 分支 `pinvou3/workspace-roots-v12`（`qiuYliangM/CodeWhale` fork，PR #54 head `9abaa87e6`；已 rebase 到 `pinvou3-clean` @`92427bd8d`——即 v0.9.12 r1 + ae7e3fb36/#53 + #58–#61 之上 18 个提交；更早的 10 提交中文信息线 head `f2526196c` 已被该英文改写线取代）：线程从单根 `cwd` 扩展为 **cwd（主根）+ workspace_roots（全量可访问根集合）**，是"单入口工作区"（项目 = 主文件夹 + 一组钥匙）的底座前提。四层落地：
