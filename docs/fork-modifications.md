...
| drift | `182 files, +14373/-1614`，净增 12759 行；r1 为 `94 files, +5022/-944`，旧 r13 为 `110 files, +10895/-1195` |
| 守护 | 100 条独立 CodeWhale `forkguard_*` 行为名（登记下限保持 54，其中 6 条钉在 `benchmark-eval-controls` 门控面）+ 父仓指纹与行为测试 |
