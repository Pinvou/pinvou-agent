...
## T3 增补：技能索引幻影工具修复（PR #56 待合入，候选 `c34c3a430`）

- 状态：[Pinvou/CodeWhale#56](https://github.com/Pinvou/CodeWhale/pull/56) open，候选提交 `c34c3a430`（r1 维护分支头 `ae7e3fb36` 之上）；父仓侧白名单/常载与指令适配随父仓 PR #490。fork-guard 以 `CANDIDATE_HEAD` 登记该候选（沿用 #408 的候选期登记约定）：登记 head 仍为公开 `pinvou3-clean` 头 `ae7e3fb36`，候选落地并推进公开分支前 `verify-public-submodule.sh` 按登记保持红。
...
| 维护分支 | `pinvou3-clean` = `c34c3a4309c03ca6308b422848e95e9000b1d7c9`（r1 基线 `1fafee7e2` 之上 14 个 squash 合入：#41/#47/#49 与 2026-09-10/11 遗留 PR 清理批次 #31/#37/#38/#39/#43/#48/#50/#51/#52/#53，及 #56 技能索引幻影工具修复） |
...
| 历史组织 | 上游之上 29 个带 DCO sign-off 的提交，归属 4 个长期主题（T1–T4）+ 2 个追加减量主题（T5 会话归档导出、T6 蜂群限流治理）；r1 之后 14 个提交全部经 PR squash 合入并过五项必需门禁 |
