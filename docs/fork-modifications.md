...
| `7f04c907d` | 修复 | 上下文来源标签相对仓库根化（#70） |
| `ba2243edd` | T2 修复 | computer-use：截图栅格坐标按区域原点绑定（#72） |
