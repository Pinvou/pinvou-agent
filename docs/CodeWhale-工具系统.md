...
> 创建：2026-05-15
> 范围：CodeWhale v0.8.37 主线，pinvou3 视角
...
| 工具 | 入口 | 用途 |
|---|---|---|
| task_create / task_list / task_read / task_cancel | with_runtime_task_tools | 持久化任务管理（CodeWhale 的 RLM workflow） |
...
查工具是否注册：在 CodeWhale 单独跑 `/tools` slash command 列当前 registry。

---

## 9. 相关代码索引

- trait + Context：`CodeWhale/crates/tui/src/tools/spec.rs`
- builder：`CodeWhale/crates/tui/src/tools/registry.rs`
- 按 mode 装配：`CodeWhale/crates/tui/src/core/engine/tool_setup.rs`
- 调度：`CodeWhale/crates/tui/src/core/engine/dispatch.rs`
- 执行：`CodeWhale/crates/tui/src/core/engine/tool_execution.rs`
- Features：`CodeWhale/crates/tui/src/features.rs`
- MCP 注入：`CodeWhale/crates/tui/src/core/engine.rs::1090`
- Subagent 注入：`CodeWhale/crates/tui/src/core/engine.rs::1077`
