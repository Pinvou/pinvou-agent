...
> Updated: 2026-09-18. Upstream `v0.9.12` r1; transition state: the parent gitlink advances along the maintenance branch ahead of the r1 tag and currently points at the T8 commits `9f1210d31`/`b5d9fa7c8`/`b11c12720` above the maintenance-branch head `7fc36e587` (they become the maintenance-branch head once upstream #65 lands) until the r2 closure realigns them.
