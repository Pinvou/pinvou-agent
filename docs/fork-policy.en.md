...
> Updated: 2026-08-21. Public maintenance baseline: upstream `v0.9.5` r8; PR #15 published the per-turn tool-security extension within the existing four long-lived topics.
...
- `Pinvou/CodeWhale#15` was squash-merged as `d127aed113529dc93754d044b9f352e9746f6b83`; `pinvou3-clean` and immutable tag `pinvou-v0.9.5-r8` are publicly reachable at that commit. Tags `r1` through `r8` remain immutable.
...
- The soft drift limits are 1,500 total changed lines and 200 fork-distinct lines per file. The published r8 baseline is 48 files and `+3222/-471`; exceeding a limit requires an explicit retention and reduction assessment.
