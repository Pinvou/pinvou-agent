...
> Updated: 2026-09-23. r2 closure complete: the immutable tag `pinvou-v0.9.12-r2` is cut at `6f780290f`; upstream #65 landed as a squash (`c5fadb86d`), so the five original T8 wave SHAs are no longer individually reachable; the parent gitlink is pinned at the maintenance-branch head `ba2243edd`, seven ahead of the r2 tag.
...
- Current fork baseline: `Pinvou/CodeWhale:pinvou3-clean` at head `6f780290f1c35e8a3c5dff86b4f76da142744b0c` (= the immutable tag `pinvou-v0.9.12-r2`), with thirty-nine DCO-signed-off commits; the immutable tag `pinvou-v0.9.12-r1` stays pinned at the r1 closure `1fafee7e26b60a59457a43bce50c63aa2ad9dbaf` (fifteen commits), followed by twenty-four squash-merged PRs: thirteen from the 2026-09-10/11 backlog batch, five from the 2026-09-17 batch (#56/#58/#59/#60/#61), three from the 2026-09-18 batch (#55/#57/#62), one from the 2026-09-20 batch (#66), and two from the 2026-09-21 batch (#64/#67). Five more merges sit on top: `d349f2537` (#63 bounded-timeout fix), `c5fadb86d` (#65 squash-merged — the T8 topic, i.e. the content of the original wave SHAs `8b132a182`/`9322fc5f6`/`df5df5f24`/`0576deb2c`/`4767c2816`: roster presentation of host profiles, the `profile_query` discovery filter, review-pinned coverage gaps, the host-roster id dedupe fix, and the load-side alignment with that dedupe), `594860ce9` (#68), `37c658da7` (#69), `7a7f65e8f` (#71), `7f04c907d` (#70 context-source labels relativized to the repo root), and `ba2243edd` (#72 screenshot-raster region-origin binding). #65 was planned to land commit-preserving to keep the wave SHAs reachable but actually landed as a squash; the parent gitlink was re-pinned to the maintenance-branch head on 2026-09-23 (forty-six commits, seven ahead of the r2 tag).
