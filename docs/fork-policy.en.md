...
> Updated: 2026-09-19. Upstream `v0.9.12` r1; transition state: the parent gitlink advances along the maintenance branch ahead of the r1 tag to `c4e6caf94` until the r2 closure realigns them.
