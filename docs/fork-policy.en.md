...
> Updated: 2026-09-20. Upstream `v0.9.12` r1; transition state: the parent gitlink advances along the maintenance branch ahead of the r1 tag to `c4e6caf94` until the r2 closure realigns them.
...
- Current fork baseline: `Pinvou/CodeWhale:pinvou3-clean` at head `c4e6caf9405bf6872df670d359731cbda7872d78`, with thirty-seven DCO-signed-off commits; the immutable tag `pinvou-v0.9.12-r1` stays pinned at the r1 closure `1fafee7e26b60a59457a43bce50c63aa2ad9dbaf` (fifteen commits formed through CodeWhale PR #44 and fast-follow PR #46), followed by twenty-two squash-merged PRs: thirteen from the 2026-09-10/11 backlog batch, five from the 2026-09-17 batch (#56/#58/#59/#60/#61), three from the 2026-09-18 batch (#55/#57/#62), and one from the 2026-09-20 batch (#66).
