...
> Updated: 2026-09-23. r2 closure complete: the immutable tag `pinvou-v0.9.12-r2` is cut at `6f780290f`; upstream #65 landed as a squash (`c5fadb86d`), so the five original T8 wave SHAs are no longer individually reachable; the parent gitlink is pinned at the maintenance-branch head `7f04c907d`, six ahead of the r2 tag.
