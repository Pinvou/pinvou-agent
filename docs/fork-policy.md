...
> 最后更新：2026-09-22（r2 已收口：不可变 tag `pinvou-v0.9.12-r2` 切在 `6f780290f`；父仓 gitlink 暂指其上的 T8 提交 `8b132a182`/`9322fc5f6`/`df5df5f24`/`0576deb2c`（上游 #65 分支头，随 #65 合入成为维护分支头），领先 r2 tag 4 个提交）
