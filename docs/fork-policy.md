...
> 最后更新：2026-09-23（r2 已收口：不可变 tag `pinvou-v0.9.12-r2` 切在 `6f780290f`；上游 #65 实际经 squash 合入为 `c5fadb86d`，原 T8 波五个 SHA 不再单独公开可达；父仓 gitlink 现钉在维护分支 `pinvou3-clean` 头 `ba2243edd`，领先 r2 tag 7 个提交）
