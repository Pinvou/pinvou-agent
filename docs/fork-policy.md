...
> 最后更新：2026-09-23（r3 已收口：不可变 tag `pinvou-v0.9.12-r3` 切在 `ba2a07768f`，gitlink/维护分支/tag 三方相等）
...
- 当前 fork 基线：`Pinvou/CodeWhale:pinvou3-clean`，head `ba2a07768fb57cd6c7eb558d1429c98cc4c74d6f`（= 不可变 tag `pinvou-v0.9.12-r3`），共 47 个带 DCO sign-off 的提交；不可变 tag `pinvou-v0.9.12-r1` 钉在 r1 收口 `1fafee7e26b60a59457a43bce50c63aa2ad9dbaf`（15 个提交），其后 32 个提交为 2026-09-10/11 backlog 批次、2026-09-17 批次、2026-09-18 批次、2026-09-20 批次、2026-09-21 批次（#64/#67）与 2026-09-22/23 批次（#63/#65/#68/#69/#70/#71/#72/#73）经 PR squash 合入。
