...
> 最后更新：2026-08-17（公开维护基线：上游 `v0.9.5` r6；PR #13 候选收敛为 4 个 Pinvou 主题）
...
- 公开维护分支：`Pinvou/CodeWhale:pinvou3-clean`，head `3bbf8421e`（`pinvou-v0.9.5-r6`）。
- 升级前基线 `03e9e1027c03ce1e4b35ab9e3ccce751b65b9624` 同时保留在 tag `pinvou-v0.9.0-r4` 和 branch `backup/pinvou3-clean-v0.9.0-r4`。
- `pinvou3-clean` 与固定标签 `pinvou-v0.9.5-r6` 均公开可达；功能退役候选已推送到 `Pinvou/CodeWhale#13`（head `e69fc890844c9ddb0d45539ed509849d860af704`），但尚未合并或创建新固定标签。
...
- 移除专用编排协议后的 PR #13 候选相对 `v0.9.5` 为 `+1852/-269，46 文件`，净增 1583 行。主要保留量来自 Automation 持久化、会话恢复生命周期、工具兼容和嵌入上下文密封；后续优先上游化通用宿主接口、会话快照/恢复 API 和 Automation 生命周期修复。
