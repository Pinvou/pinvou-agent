...
> 留档日期：2026-06-03。验证基线：CodeWhale submodule `0c9542dd`，pinvou3-app（card-pool-agency 分支）。
...
pinvou3 **fork patch #41**（`CodeWhale/crates/tui/src/skills/mod.rs:601` `skills_directories_with_home`）把它砍到只剩：
