...
const expectedProtocolHashes = {
  ...
  chat: '37afa9068d7cf001439a9101dd7f55eb8aba31837ca11a36ddf61c3cf85a5c5d',
  ...
  settings: '426bdcd622f4b73769d11df0e243e4ec615b16f115b22710c5d9a622aeea0e7a',
...
const expectedApi = {
  ...
  models: ['deleteModel', 'getEffectiveModelConfig', 'getImageInputCapability', 'loadModels', 'loadSessionModel', 'revealModelApiKey', 'saveModel', 'setActiveModel', 'switchModel', 'testModelConnection'],
