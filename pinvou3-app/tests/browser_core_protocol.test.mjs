...
test('work instructions define a durable and verified loopback preview workflow', () => {
  ...
  assert.doesNotMatch(instructions, /background=true/);
  ...
  assert.match(instructions, /Keep the terminal session running until the user explicitly ends the preview/i);
