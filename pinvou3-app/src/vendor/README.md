...
be reapplied after refreshing the upstream file;
`tests/compat_audit.test.mjs` pins it with a contract assertion.
...
(`marked@14.1.4` / `dompurify`), transpiled and bundled by Vite for the
