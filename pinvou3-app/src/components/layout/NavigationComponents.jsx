...
import { isImeComposing } from '../../shared/ime-guard.mjs';
    ...
    const RecentItem = memo(function RecentItem({ chat, active, personaTarget, theme, t, onSelect, onRename, onDelete, onTogglePinned, onOpenFolder, onExportArchive, onArchive, onMoveToProject, dragKind = 'session', dragging, onPickUp, dndPayload, dndDisabled }) {
      const isDark = theme === 'dark';
