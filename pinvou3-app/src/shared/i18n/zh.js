...
// Normal-chat draft-state working directory selector
// (features/chat/ComposerWorkspaceSelector.jsx; wording mirrors the code-mode
// uiCodex draft selector). The system directory dialog title is provided by
// the bridge's pickFolderTitle (the dead key chooseDirectoryDialog was removed
// in the #445 review).
dictZh.uiChatWorkspace = {
  ...
  // working-directory-bound session (semantics mirror code mode uiCodex's
  // modeYoloConfirm*, but the wording says "working directory" instead of
  // "project directory", hence separate keys).
