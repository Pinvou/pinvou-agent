...
{ key:'qr', label:'扫码登录', sub:'钉钉 App 扫一扫' },
  ...
  connFailed:'连接失败', dingtalkSkillsFailed:err=>`钉钉已授权，但技能启用失败：${err}`, wecomSkillsFailed:err=>`企业微信已连接，但工具状态保存失败，新会话将默认开启该工具；请在输入框工具列表中手动关闭：${err}`, feishuSkillsFailed:err=>`飞书已连接，但技能启用失败，新会话将默认开启该工具；请在输入框工具列表中手动关闭：${err}`, tmeetAuthIncomplete:'腾讯会议授权未完成，请完成浏览器登录后重试',
