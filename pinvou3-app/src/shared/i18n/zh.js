...
export const dictZh = {
 ...
 sudo: '高级执行权限 (Sudo)', 
        ...
        uiKeychain: { accessibleFolders:n=>`可访问的 ${n} 个文件夹`, primaryBadge:'主', unknownDirectory:'未知目录', alignAction:'对齐到项目', alignActionDesc:'把本对话的可访问文件夹更新为项目当前的全部文件夹（下个回合生效）', alignDone:'已对齐到项目', alignNoChange:'已是最新，无需对齐', alignBusy:'当前回合结束后重试', alignWriteSkipped:'磁盘已是目标状态；未打断活动会话', alignFailed:'对齐失败' },
