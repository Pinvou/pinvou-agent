...
failure: 'PPT 生成能力准备失败，请稍后重试。',
  ...
  missingCapabilities: (ids) => `缺少能力：${ids}`, switchedOffPacks: (ids) => `以下工具当前处于关闭状态，请在输入框工具列表中开启后重试：${ids}`,
