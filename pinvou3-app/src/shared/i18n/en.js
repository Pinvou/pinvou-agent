...
export const dictEn = {
  ...browserEn,
        ...
        composerBuiltinAuto: 'Built-in', composerSkillInUse: 'In use', composerSkillAllDisabled: 'All skills for this session type are off — enable them above', composerModeControlled: 'Controlled by mode', composerReadonlySwitch: 'Controlled by mode, cannot be toggled manually',
