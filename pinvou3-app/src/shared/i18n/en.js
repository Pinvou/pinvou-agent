...
export const dictEn = {
 ...
 sudo: 'Advanced execution (Sudo)', 
        ...
        uiManageFolders: { title:'Manage folders', renameHint:'Click to rename the project', emptyRoots:'This project has no folders (label-only project)', primaryBadge:'Primary', setPrimaryHint:'Make primary folder', removeAction:'Remove', removeConfirm:'Remove', removeConfirmBody:'In-flight conversations keep access to this folder until they end; future new conversations will not get it. Explicitly filed sessions stay where they are; auto-grouped sessions move to ungrouped.', removePrimaryBlocked:'This is the primary folder: make another folder primary first, then remove it.', addAction:'Add folder…', addDuplicate:'This folder is already in the project', addNoticeRestricted:"New conversations in this project will be able to access this folder", addNoticeVisibility:'The model will know this folder belongs to the project for new conversations', exclusionSection:'Folders excluded from auto-projects', neverMaterializeAction:'Stop auto-project', neverMaterializeHint:'Add this folder to the exclusion list: no project is auto-materialized for it again (this project and existing sessions are unaffected)', revokeExclusion:'Revoke', exclusionDone:'Exclusion list updated' },
