...
export const dictEn = {
  ...browserEn,
        ...
        queuedSave: 'Save', queuedEditCancel: 'Cancel editing', queuedActionFailed: 'The action did not complete. The message may already be in the current response; try again later.', queuedEmpty: 'Message cannot be empty', queuedEditInterrupted: 'The queued message left the queue before this edit was saved; the modified text was discarded',
