...
export const dictEn = {
  ...browserEn,
        ...
        uiProjects: { convertToProject:'Convert to project', projectNamePlaceholder:'Project name', renameProject:'Rename project', deleteProject:'Delete project', deleteConfirmLabel:'Delete this project?', deleteProjectHint:'Conversations are kept and return to ungrouped', moveToProject:'Move to project…', moveToProjectNamed:name=>`Move to "${name}"`, moveOut:'Remove from project', moveToUngrouped:'Move to ungrouped', temporaryBadge:'Temporary workspace', folderUnavailable:'Folder unavailable', rebindFolder:'Rebind', moveConfirmTitle:'Move conversation into this project?', moveConfirmBody:(project, folder)=>`The conversation moves into "${project}". Its folder ${folder} stays outside the project; only this conversation is filed.`, moveConfirm:'Move', searchPlaceholder:'Search projects', noProjects:'No projects yet', ungrouped:'Ungrouped', currentProject:'Current project', movedNotice:'Conversation moved', movedNoticeWithFolder:folder=>`Conversation moved; folder ${folder} added`, noMatchProject:'No matching projects', opFailed:'Project operation failed', rebindTitle:'Rebind project folder', rebindConfirm:'Move and rebind', rebindSessionsHint:()=>'Every session under this folder will switch to the new directory', rebindSuccess:n=>`Rebound ${n} conversation(s)`, rebindOldExistsWarn:'The original folder still exists; the two locations will point to different directories. Continue anyway?', rebindNestedRejected:'The new folder cannot be inside the old one; choose a different location', rebindPartial:(ok, failed)=>`Rebound ${ok} sessions; ${failed} failed - retry the rest`, rebindBusyAfter:n=>`${n} sessions started a new turn during the rebind; if they misbehave, retry once when idle`, manageFolders:'Manage folders', newSessionHere:'New conversation',},
