...
const codexEn = {
  ...
  rewindUndoChanges:'Code changes to undo', rewindConversationLabel:'Conversation',
  ...
  rewindStatus:{added:'Added',modified:'Modified',deleted:'Deleted',renamed:'Renamed',copied:'Copied',other:'Other'},
