...
export const dictEn = {
  ...browserEn,
        ...
        queuedSave: 'Save', queuedEditCancel: 'Cancel editing', queuedActionFailed: 'The action did not complete. The message may already be in the current response; try again later.', queuedEmpty: 'Message cannot be empty',
