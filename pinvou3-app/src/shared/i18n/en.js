...
export const dictEn = {
  ...browserEn,
        ...
        uiWorkspacePicker: { title:'Choose workspace', searchPlaceholder:'Search projects or paths', empty:'No projects yet — browse a folder or start a temporary chat', multiRootSummary:(n, primary)=>`${n} folders · primary: ${primary}`, primaryRootBadge:'Default', noticeRestricted:n=>`This conversation will be able to access this project's ${n} folder${n === 1 ? '' : 's'}`, noticeVisibility:n=>`The model will know these ${n} folder${n === 1 ? '' : 's'} belong to this conversation`, temporary:'Temporary chat', temporaryDesc:'No directory binding', browse:'Browse for another folder…', browseDesc:'Start a new conversation anchored at the picked folder', excludedTitle:'Auto-project is off for this folder', excludedBody:name=>`"${name}" is on the exclusion list and will not be auto-filed into a project. You can still start a plain folder conversation with it.`, excludedProceed:'Start with this folder anyway', unknownDirectory:'Unknown directory' },
