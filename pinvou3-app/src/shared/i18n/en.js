...
export const dictEn = {
 ...
 sudo: 'Advanced execution (Sudo)', 
        ...
        uiComputerUse: {
          ...
          confirmKeyChordMasked:(chord, count)=>chord?`Press ${chord} + ${count} masked characters`:`Press ${count} masked characters`,
          confirmHoldKeyMasked:(chord, count, ms)=>chord?`Hold ${chord} + ${count} masked characters for ${ms} ms`:`Hold ${count} masked characters for ${ms} ms`,
