...
export const dictEn = {
  ...browserEn,
        ...
        uiProjects: { convertToProject:'Convert to project', projectNamePlaceholder:'Project name', renameProject:'Rename project', deleteProject:'Delete project', deleteConfirmLabel:'Delete this project?', deleteProjectHint:'Conversations are kept and return to ungrouped', moveToProject:'Move to project…', moveOut:'Remove from project', moveToUngrouped:'Move to ungrouped', temporaryBadge:'Temporary workspace', folderUnavailable:'Folder unavailable', rebindFolder:'Rebind', addFolderTitle:'Add folder to project?', addFolderBody:folder=>`The project will include the session's current working directory (${folder}); new sessions created there will join this project automatically.`, searchPlaceholder:'Search projects', noProjects:'No projects yet', ungrouped:'Ungrouped', currentProject:'Current project', movedNotice:'Conversation moved', movedNoticeWithFolder:folder=>`Conversation moved; folder ${folder} added`, addFolderConfirm:'Add and move', moveOnly:'Move only', noMatchProject:'No matching projects', opFailed:'Project operation failed', rebindTitle:'Rebind project folder', rebindConfirm:'Move and rebind', rebindSessionsHint:n=>`${n} conversation(s) will use the new folder`, rebindSuccess:n=>`Rebound ${n} conversation(s)`, rebindOldExistsWarn:'The original folder still exists; the two locations will point to different directories. Continue anyway?' },
