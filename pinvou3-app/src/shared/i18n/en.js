...
const codexEn = {
  ...
  activeHint:'Tool calls, reasoning, plans, and permission requests are shown with their original ACP semantics, separate from 鲜小助 work-session messages.',
  nativeActiveHint:'Tool calls, reasoning, and confirmations are shown with 鲜小助 Engine semantics, on the same engine lane as work sessions.',
  ...
  nativeDraftHint:'Start typing to create a temporary session, or choose a project directory from the lower-left corner so 鲜小助 works directly in it.',
  ...
  temporarySessionDesc:'Use an isolated directory managed by 鲜小助', recentProjects:'Recent projects',
  ...
  bridgeRepair:'Repair or reinstall 鲜小助. In development, run npm run prepare:codex-bridge.',
  ...
  finishAgentAuth:agent=>`Complete ${agent} authorization in the browser; 鲜小助 will connect automatically`,
  ...
  finishBrowserAuth:'Complete ChatGPT authorization in the browser; 鲜小助 will connect automatically',
...
const acpProvidersEn = {
  ...
  thirdPartyWarning:'鲜小助 never uploads your API Key.',
...
export const dictEn = {
  ...browserEn,
        ...
        remoteKbPromoteOwner: 'Make owner', remoteKbDemoteOwner: 'Remove owner', remoteKbPromoteOwnerConfirm: 'Make “{name}” an owner? They can manage sharing and members.', remoteKbDemoteOwnerConfirm: 'Remove owner access from “{name}”?', remoteKbModelTitle: 'Semantic search model', remoteKbModelReady: 'Available', remoteKbModelMissing: 'Not downloaded', remoteKbModelDownloading: 'Downloading; this continues after 鲜小助 closes', remoteKbDownloadModel: 'Download', remoteKbModelDownloadingAction: 'Downloading', remoteKbPermanentDelete: 'Delete permanently', remoteKbPermanentDeleteConfirm: 'Permanently delete “{name}”? This cannot be undone.',
        ...
        kbOutSub: 'Everything you and 鲜小助 have made, all in one place.',
        ...
        kbOutEmpty: 'No outputs yet', kbOutEmptyHint: 'Chat with 鲜小助 — things you make together will appear here.',
        ...
        kbModelPkgName: '鲜小助 Embedding Model', kbModelPkgSub: 'Multilingual vector model · int8 quantized · CPU-only, fully local',
        ...
        communityQrAlt: '鲜小助 QQ group QR code', communityQrPlaceholder: 'QR placeholder', communityChannelTag: 'Chinese QQ community',
        ...
        chatGreeting: 'Hi — what would you like to work on today?', artifacts: 'Artifacts', placeholder: 'Ask 鲜小助 or enter a command', disclaimer: '鲜小助 may display inaccurate info, so double-check.', ctxUsage: 'Context',
        ...
        // —— Chat & global chrome ——
        appTitle: BRAND_NAME, winMin: 'Minimize', winMax: 'Maximize', winClose: 'Close',
        ...
        // 鲜小助 review card. 品/悟 glyphs are brand marks, kept; surrounding text follows language.
        pvLoadingPin: '鲜小助 品 · Review', pvLoadingWu: '鲜小助 悟 · Explore',
...
dictEn.uiChatView = {
  ...
  placeholderDesignPpt:'Describe the PPT topic you want to generate or the changes to make',
...
dictEn.uiPlatformMisc = {
  htmlLang: 'en',
  appTitle: BRAND_NAME,
  petTitle: '鲜小助 Desktop Companion',
  hostFilePicker: {
...
dictEn.uiSettingsView = {
  ...
  memorySummary: total => `鲜小助 remembers your preferences, work context, and recent activities so follow-up conversations pick up the context more easily. ${total} active memories recorded.`,
  memoryOffDesc: 'Once enabled, 鲜小助 can remember how to address you, your stable preferences, work context, and recent activities, so you repeat yourself less.',
  ...
  memoryOffNotice: 'Once memory is enabled, 鲜小助 uses this information in conversations and automatically organizes new long-term and recent memories.',
  ...
  memoryRecentHint: 'Recent memories record what is in progress or just finished, helping 鲜小助 pick up the context. They fade automatically over time, and you can archive or delete them manually.',
...
Object.assign(dictEn.uiSettingsDetail, {
  ...
  redetect:'Check again', detect:'Detect', noRunningLocalModel:'No running local model detected', modelNotLoadedTag:'Not loaded', modelNotLoadedHint:'Not in memory yet; it will load automatically on first use',
