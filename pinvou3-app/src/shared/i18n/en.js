...
export const dictEn = {
  ...browserEn,
        ...
        uiProjects: { convertToProject:'Convert to project', projectNamePlaceholder:'Project name', renameProject:'Rename project', deleteProject:'Delete project', deleteConfirmLabel:'Delete this project?', deleteProjectHint:'Conversations are kept and return to ungrouped', moveToProject:'Move to project…', moveOut:'Remove from project', moveToUngrouped:'Move to ungrouped', temporaryBadge:'Temporary workspace', folderUnavailable:'Folder unavailable', rebindFolder:'Rebind', addFolderTitle:'Add folder to project?', addFolderBody:folder=>`The project will include folder ${folder}; new sessions created there will join this project automatically.`, searchPlaceholder:'Search projects', noProjects:'No projects yet', ungrouped:'Ungrouped', currentProject:'Current project', movedNotice:'Conversation moved' },
