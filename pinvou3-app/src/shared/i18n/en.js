...
dictEn.uiToolDetails.actions = { connectedTmeet:'Tencent Meeting connected', enabled:'Connected. Tool switches are off by default; turn this on in the composer tools list', disconnectedTmeet:'Tencent Meeting disconnected', connectingIma:'Connecting Tencent ima', validatingIma:'Validating OpenAPI credentials…', connectedIma:'Tencent ima connected', imaEnabled:'IMA connected. Tool switches are off by default; turn this on in the composer tools list.', imaFailed:'IMA connection failed', disconnectedIma:'Tencent ima disconnected', operationFailed:'Operation failed. Please retry' };
...
failure: 'PPT generation capability could not be prepared. Please try again later.',
  ...
  missingCapabilities: (ids) => `Missing capabilities: ${ids}`, switchedOffPacks: (ids) => `These tools are currently switched off — enable them in the composer tools list and retry: ${ids}`, notAppliedPacks: (ids) => `These packs are not active yet — they may still be installing. Please retry: ${ids}`,
...
desktopHint:'Install Obsidian on the desktop and create a vault first, then check again here.',
  ...
  connectedBanner:name=>`${name} connected · tool switches are off by default; enable it in the composer tools list`,
  connectedBannerIma:'Tencent ima connected · tool switches are off by default; enable it in the composer tools list',
...
{ key:'qr', label:'Scan to sign in', sub:'Scan with the DingTalk app' },
  ...
  connFailed:'Connection failed', dingtalkSkillsFailed:err=>`DingTalk authorized, but enabling the skill failed: ${err}`, wecomSkillsFailed:err=>`WeCom connected, but saving the tool state failed — new sessions will enable it by default; switch it off in the composer tools list: ${err}`, feishuSkillsFailed:err=>`Feishu connected, but enabling the skill failed — new sessions will enable it by default; switch it off in the composer tools list: ${err}`, tmeetSkillsFailed:err=>`Tencent Meeting connected, but enabling the skill failed — new sessions will enable it by default; switch it off in the composer tools list: ${err}`, tmeetAuthIncomplete:'Tencent Meeting authorization is incomplete—finish the browser sign-in and retry',
