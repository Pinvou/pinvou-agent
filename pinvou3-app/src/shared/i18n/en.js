...
Object.assign(dictEn.uiSettingsDetail.modelDescriptions, {
  ...
  '填写本地服务暴露的模型 ID':'Enter the model ID exposed by the local service',
  '手动填写模型 ID':'Enter a model ID manually', '手动填写模型 ID 和服务地址':'Enter the model ID and service URL manually',
  '手动填写 Coding Plan 模型 ID':'Enter a Coding Plan model ID manually',
  ...
  'V4.1-Flash 主力，1M 上下文，支持图片输入':'V4.1-Flash mainline, 1M context, image input', '2026-09-14 起自动路由至 deepseek-flash 计费':'Routed to deepseek-flash pricing from 2026-09-14',
