...
{ key:'qr', label:'Scan to sign in', sub:'Scan with the DingTalk app' },
  ...
  connFailed:'Connection failed', dingtalkSkillsFailed:err=>`DingTalk authorized, but enabling the skill failed: ${err}`, wecomSkillsFailed:err=>`WeCom connected, but saving the tool state failed — new sessions will enable it by default; switch it off in the composer tools list: ${err}`, feishuSkillsFailed:err=>`Feishu connected, but enabling the skill failed — new sessions will enable it by default; switch it off in the composer tools list: ${err}`, tmeetAuthIncomplete:'Tencent Meeting authorization is incomplete—finish the browser sign-in and retry',
