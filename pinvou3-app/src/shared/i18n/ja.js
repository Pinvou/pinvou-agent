...
dictJa.uiArtifacts = {
  ...
  diLineHeight:'行の高さ', diLetterSpacing:'文字間隔', diBgSize:'背景サイズ', diBgSizePlaceholder:'cover / contain', diBgPosition:'背景位置',
