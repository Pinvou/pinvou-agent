...
const codexJa = {
  ...
  branchSwitchCarry:'変更を持って切り替え', branchSwitchCarryHint:'変更をワークスペースごと新しいブランチに引き継ぎます。競合時は切り替えが失敗し、変更はそのまま保持されます',
  branchSwitchStash:'Stash して切り替え', branchSwitchStashHint:'変更を先に stash（git stash -u）し、切り替え後に自動復元します。復元が競合した場合 stash は保持されます',
  branchSwitchCommit:'コミットして切り替え', branchSwitchCommitHint:'すべての変更（未追跡ファイルを含む）を現在のブランチにコミットしてから切り替えます',
  branchSwitchCommitPlaceholder:'コミットメッセージ（必須）',
  branchSwitchCommitPrompt:(branch)=>`すべての未コミットの変更を現在のブランチにコミットしてから、「${branch}」に切り替えます：`,
  branchSwitchBusyError:'Agent が実行中です。現在のタスクが完了してからブランチを切り替えてください',
  ...
  nativeActiveHint:'ツール呼び出し、思考、選択確認は Pinvou Engine の意味で表示され、作業セッションと同じエンジン経路を共有します。',
  draftHint:'入力すると一時セッションを作成できます。入力欄の左下からプロジェクトディレクトリを選ぶこともできます。',
  nativeDraftHint:'入力すると一時セッションを作成できます。入力欄の左下からプロジェクトディレクトリを選ぶと、Pinvou がその中で直接作業します。',
  ...
  rewindPreRestoreNote:'現在のコード状態は先にロールバックポイントとして自動保存されるため、あとから取り消して元に戻せます。',
  ...
  rewindNoticeRestored:n=>n>0?`ターン ${n} の末尾まで巻き戻しました：コードと会話が復元されました。巻き戻し前のコード状態はロールバックポイントとして自動保存済みです。あとから巻き戻しを取り消せます。`:'ターン 1 の前まで巻き戻しました：コードと会話が復元されました。巻き戻し前のコード状態はロールバックポイントとして自動保存済みです。あとから巻き戻しを取り消せます。',
  ...
  compactStart:'コンテキストを圧縮中', compactDone:'コンテキストを圧縮しました', compactFail:'コンテキストの圧縮に失敗しました', compactCancel:'コンテキストの圧縮をキャンセルしました',
  nativeToolGateDecision:(tool,decision,reason,risk,agent)=>`権限ゲート: ${tool || 'ツール'} を${decision === 'allowed' ? '許可' : decision === 'denied' ? '拒否' : 'レビュー不能のため拒否'}${agent ? `（エージェント ${agent}）` : ''}${risk ? ` · リスク ${risk}` : ''}${reason ? ` · ${reason}` : ''}`,
...
const acpProvidersJa = {
  ...
  modelSlotsTitle:'個別モデル（opus / sonnet / haiku / fable / サブエージェント）', modelSlotsHint:'上のモデルが自動入力されています。個別に変更可能です。すべて必須です。空欄だとサブエージェントが公式トラフィックを使用します。', modelSlotsRequired:'5 つの個別モデルスロットはすべて必須です',
  ...
  contextWindow:'コンテキスト長', contextWindowPlaceholder:'例：200000 / 1048576', contextWindowHint:'空欄の場合は CLI のデフォルト（200000）を使用します。誤った値を設定すると会話が早く打ち切られます。不明な場合は空欄にしてください。', contextWindowInvalid:'コンテキスト長は正の整数で入力してください',
  ...
  exportWarningTitle:'エクスポートファイルに平文キーが含まれます', exportWarningDesc:'エクスポートファイルには API Key が平文で含まれます。大切に保管し、他人と共有しないでください。テキストを選択して手動でコピーしてください。', selectAll:'すべて選択',
  ...
  installCmd:'実行コマンド', installLatest:'最新出力', phaseChecking:'セルフチェック中…', phaseInstalling:'ダウンロード・インストール中…', phaseDone:'完了', phaseFailed:'失敗', phaseCancelled:'キャンセル済み',
  rechecking:'再確認中…',
  ...
  sessionProvider:'セッションのプロバイダー', sessionProviderDesc:'このセッションで固定するプロバイダー。デフォルトはグローバル設定に従います', sessionOfficial:'グローバル設定に従う',
...
const jaBase = {
  ...browserJa,
        langTag: 'ja',
        acpAgent: 'ACP Agent',
        newChat: '新しいチャット', currentChat: '現在のチャット', searchChats: 'チャットを検索', scheduledPlans: '定期タスク', monitor: '稼働状態', workflow: 'ワークフロー', multiAgent: 'スワームモード', multiAgentDesktopOnly: 'このスワーム会話は現在デスクトップアプリでのみ利用できます。', toolStore: 'プラグインセンター', cardPool: 'カードプール', recent: '履歴', sidebarTaskList: 'タスク一覧', sidebarTaskFilter: 'フィルター', sidebarTaskFilterAll: 'すべて', sidebarTaskFilterPinned: '固定', sidebarTaskFilterCode: 'プロジェクト', sidebarTaskFilterCodeSessions: 'コードセッション', sidebarTaskFilterScheduled: '定期タスク', sidebarTaskSort: '並び替え', sidebarTaskSortPinnedFirst: '固定を優先', sidebarTaskSortRecent: '最近の更新', sidebarTaskEmpty: 'タスクはありません', sidebarViewAll: 'すべて表示', sidebarSection: 'タスクリスト', sidebarDateGrouping: '日付でグループ化', sidebarDateGroupingDesc: 'タスクを日付ごとにまとめ、今日分を既定で展開', sidebarNavExpand: 'ナビゲーションを展開', sidebarNavCollapse: 'ナビゲーションを折りたたむ', sidebarCollapseAll: '折りたたむ', sidebarExpandAll: '展開', sidebarTaskStyle: 'スタイル', sidebarResize: 'ドラッグでサイドバーの幅を調整、ダブルクリックでリセット', settings: '設定', tearoffTitle: '切り離し', mobileMore: 'その他',
        ...
        remoteKbHeroTitle: '共有ナレッジ',       
        remoteKbDesc: 'この端末で作成するか、チームの共有ナレッジに参加します。', remoteKbRefresh: '更新', remoteKbConnectTitle: '共有ナレッジに参加',  remoteKbDeviceName: '名前を入力', remoteKbConnect: '接続', remoteKbConnected: '共有ナレッジに参加しました', remoteKbServers: '共有ナレッジ', remoteKbNoServers: '共有ナレッジはありません', remoteKbReady: '利用可能', remoteKbNotReady: '検索できません', remoteKbOffline: 'オフライン', remoteKbManage: '管理可能', remoteKbReadOnly: '読み取り専用',  remoteKbShowTrash: 'ゴミ箱を表示', remoteKbDisconnect: '切断', remoteKbRemoveConfirm: 'この端末の接続と、チャットにリンク中のすべてのコレクションを解除します。続行しますか？', remoteKbCollections: '共有コレクション', remoteKbCollectionName: '新しいコレクション名', remoteKbCreate: '作成', remoteKbCollectionCreated: 'コレクションを作成しました', remoteKbNoCollections: 'コレクションはありません', remoteKbDocuments: '文書', remoteKbChunks: 'チャンク', remoteKbRestore: '復元', remoteKbTrash: 'ゴミ箱へ', remoteKbTrashConfirm: 'このコレクションをゴミ箱へ移動しますか？文書は復元できます。', remoteKbFiles: '文書', remoteKbUpload: 'ファイルをアップロード',  remoteKbNoDocuments: '文書はありません', remoteKbStatusPending: '処理中', remoteKbStatusReady: '利用可能', remoteKbStatusFailed: '処理に失敗', remoteKbStatusUnknown: '状態不明', remoteKbDownload: '原本をダウンロード', remoteKbDownloaded: 'ダウンロードしました', remoteKbTestSearch: '検索テスト', remoteKbSearchPlaceholder: '質問またはキーワード', remoteKbSearch: '検索', remoteKbDesktopOnly: '共有ナレッジには PINVOU デスクトップ版が必要です。',
        remoteKbAddServer: '共有ナレッジに参加',  remoteKbNewCollection: '新規コレクション', remoteKbCancel: 'キャンセル', remoteKbClose: '閉じる', remoteKbCollapse: '閉じる', remoteKbDone: '完了', remoteKbUploading: '処理中…', remoteKbUploadTitle: '文書をアップロード', remoteKbStartUpload: 'アップロード', remoteKbRetryFailed: '失敗項目を再試行', remoteKbUploadingFile: 'アップロード中', remoteKbUploadDone: '完了', remoteKbUploadPendingIndex: '処理中', remoteKbUploadStillIndexing: '処理を継続中', remoteKbUploadIndexFailed: '処理に失敗', remoteKbUploadFailed: 'アップロード失敗', remoteKbUploadSuccess: '{count} 件の文書をアップロードしました',  remoteKbUploadRefreshFailed: '一覧を更新できませんでした：{error}', remoteKbFileName: '名前', remoteKbStatus: '状態', remoteKbSize: 'サイズ',
        ...
        remoteKbJoinSource: '共有リンクまたはプライベートアドレス', remoteKbJoinSourcePlaceholder: '共有リンク、または 192.168.1.20:3210 を入力', remoteKbJoinHint: 'LAN、Tailscale の 100.x、*.ts.net:ポートに対応します。プライベート直結では先にサービス ID を確認します。',  remoteKbJoinRequested: '参加申請を送信しました', remoteKbPendingTitle: '承認待ち', remoteKbPendingDesc: '所有者の承認後、自動的に参加します。', remoteKbCancelRequest: '申請を取り消す', remoteKbOwner: '所有者', remoteKbGovern: '管理', remoteKbGovernTitle: '共有とメンバー', remoteKbPeopleTab: 'メンバーと招待', remoteKbServiceTab: 'サービスと保守',
        remoteKbShareTitle: 'チームを招待', remoteKbShareDesc: '共有リンクは既定で24時間有効で、複数人が申請できます。', remoteKbCreateShare: 'リンク作成', remoteKbAutoApproveRead: 'リンク有効中は読み取り専用申請を自動承認', remoteKbCopy: 'リンクをコピー', remoteKbLinkCopied: '共有リンクをコピーしました', remoteKbRecoveryCopied: '復旧コードをコピーしました', remoteKbCopyFailed: 'コピーできませんでした。テキストを選択して手動でコピーしてください。',  remoteKbRequestsTitle: '参加申請', remoteKbNoRequests: '保留中の申請はありません', remoteKbApproveRead: '読み取り', remoteKbApproveManage: '管理', remoteKbReject: '拒否', remoteKbStopShare: '停止', remoteKbAutoReadShort: '自動読取', remoteKbMembersTitle: 'メンバー', remoteKbThisDevice: 'この端末', remoteKbRevoked: '無効', remoteKbRestoreAccess: '復元', remoteKbRevokeAccess: '無効化', remoteKbMemberAccess: 'メンバー権限', remoteKbRemoveMember: 'メンバー「{name}」を削除', remoteKbRemoveMemberAction: 'メンバーを削除', remoteKbRemoveMemberConfirm: '「{name}」を完全に削除しますか？',
        ...
        kbRescan: '再スキャン', kbScanning: 'スキャン中',  kbScanNow: 'このPCをスキャン',
          
         
        kbSearchPlaceholder: '例：先週のpdf、10mb以上の動画', 
         kbNoResults: '一致するファイルがありません', kbScanningHint: 'インデックス作成中…スキャン済み',
        ...
        kbOutSub: 'PINVOU と一緒に作ったものをここにまとめます。',
         kbOutSearchList: '名前 / 元チャットで検索',
        kbOutCatAll: 'すべて', kbOutCatWeb: 'Web', kbOutCatDoc: '文書', kbOutCatImg: 'ポスター', kbOutCatPpt: 'PPT',
         
        kbOutGroupToday: '今日', kbOutGroupWeek: '今週',  kbOutGroupCount: (n) => `${n} 件`,
        kbOutMonthLabel: (y, m) => `${y}年${String(m).padStart(2, '0')}月`, kbOutGroupUnknown: '日時不明',
            kbOutColActions: '操作',
        kbOutTodayPrefix: '今日', kbOutWeekdays: ['日','月','火','水','木','金','土'],
          kbOutContinue: '続きを作る', kbOutNewProject: '新規プロジェクト', kbOutGallery: 'ギャラリー', kbOutList: 'リスト',  kbOutOpenFolder: 'フォルダを開く',
        kbOutEmpty: '成果物はまだありません', kbOutEmptyHint: 'PINVOU とチャットして作ったものがここに表示されます。',
        kbOutContinuePrefill: (name) => `「${name}」を続けて改善`, kbOutRequirementLabel: '依頼内容：', 
        kbCatAll: 'すべて', kbCatDoc: '文書', kbCatSheet: '表', kbCatPpt: 'スライド', kbCatPdf: 'PDF', kbCatImg: '画像', kbCatZip: '圧縮',
         kbAddToKb: '知識に追加', kbAdd: '追加', kbAddFiles: 'ファイル追加', kbAddFolder: 'フォルダーを追加', kbIndexing: '解析中',
        kbBrowseByType: 'タイプ別に表示',      kbAllFiles: 'すべてのファイル',  kbColName: 'ファイル名',  kbColSize: 'サイズ', kbColTime: '更新日時',   kbCollUnit: '件のコレクション', kbColColl: '所属コレクション', kbStatus: '状態',
        ...
        kbModelChipDownload: '約 {n} MB', kbModelChipInstalled: 'インストール時 ~{n} MB', kbModelChipOffline: '完全オフライン', kbModelChipLang: '中国語・英語 / 多言語',
        ...
        kbDeleteColl: 'コレクション削除', kbRemove: '削除', kbCollEmpty: '文書がありません。「ファイル追加」で追加。', kbNoCollFiles: 'ナレッジにファイルがありません', kbAllColls: 'すべて', kbDelCollConfirm: 'コレクション「{n}」を削除しますか？', kbDelCollWarn: 'このコレクションの索引（{c} 件の文書）のみ削除します。ディスク上の元ファイルは削除されません。', kbDelete: '削除', kbRemoveDocConfirm: 'ナレッジから「{n}」を削除しますか？', kbRemoveDocWarn: 'ナレッジ内の索引のみ削除します。ディスク上の元ファイルは影響を受けません。', kbRemoveFailed: '文書を削除できませんでした', 
                  kbCollNamePh: 'コレクション名', kbCollCatPh: 'カテゴリ（任意）', kbCancel: 'キャンセル', kbCreate: '作成',
        sysStatus: 'システム状態',  gpu: 'GPU', gpuUnavail: '状態を取得できません', 
        cpu: 'CPU',    
        vram: 'VRAM 使用量', core: 'コア使用率', temp: '温度', power: '消費電力', unifiedMem: 'ユニファイドメモリ',
        ram: 'システムメモリ (RAM)', used: '使用中',  total: '合計', swap: 'スワップ領域',
        vllm: '推論エンジン', ctx: 'コンテキスト長',  queue: 'タスク待ち', kv: 'KV ヒット率', ttft: 'TTFT', tps: 'TPS（生成速度）', tokTotal: '累計トークン・生成/入力',         app: 'アプリサービス', 
        curVer: '現在のバージョン',  uptime: '稼働時間', runningMemory: '実行メモリ', temporaryMemory: '一時メモリ', memoryPressure: 'メモリ負荷', normal: '正常', localProcessor: 'ローカル演算', processorLoad: 'プロセッサ負荷', graphicsLoad: 'グラフィック負荷', sharedMemory: '共有メモリ', deviceTemp: 'デバイス温度', currentModel: '現在のモデル', localRunning: 'ローカル実行', remoteService: 'リモート', available: '利用可能', unavailable: '利用不可', historyReuse: '履歴再利用率',  modelReadAmount: 'モデル読込量', modelOutputAmount: 'モデル出力量', modelReadHint: '入力が多いほど応答は遅く、消費も増えます', modelOutputHint: '出力が多いほど返信は長く、消費も増えます', resetCount: 'カウントをリセット', contextHint: '保持できる会話範囲', queueHint: '処理中 / 待機中', ttftHint: '返信開始までの待ち時間', tpsHint: '返信の出力速度', reuseHint: '高いほど速く、Token も節約', totalMemory: '総メモリ',
        appearance: '外観と言語', lang: '表示言語',  theme: 'テーマ', themeDesc: 'お好みの配色を選択',
        light: 'ライト', dark: 'ダーク', followSystem: 'システムに従う',
        notifications: '通知',
        ...
        modelContextWindow: 'コンテキスト長（tokens）',
                ...
                clearSearch: '検索をクリア',  sendMsg: '送信', apiKeyGateTitle: 'API Key の設定が必要です', apiKeyGateDesc: '現在のモデルはクラウドモデルです。チャットを開始するには API Key を設定してください。', apiKeyGateBtn: '設定する',
        
        detectingLocalVllm: '検出中…',
        
        
        addModel: '＋ モデルを追加', editModel: '編集',  setActiveModel: 'デフォルトに設定', 
        ...
        uiMonitor: { bridgeNotReady:'ブリッジ未準備', readFailed:'読み込み失敗', reading:'読み込み中', unverified:'未確認', authFailed:'認証失敗', bridgeError:'モニターブリッジが未準備です。Tauri アプリのウィンドウで開いてください。', readError:e=>`モニターの読み込みに失敗: ${e}`, activity:'実行状況' },
        ...
        uiComputerUse: {
          settingsSection:'コンピュータ操作',
          settingsToggle:'コンピュータ操作（アシスタントによる画面の確認と操作を許可）',
          settingsHint:'有効にすると、アシスタントはスクリーンショットの撮影とマウス・キーボードの操作ができ、誤操作のリスクがあります。各セッションで最初の操作の前に再度同意を求め、重要な操作は都度確認が必要です。',
          platformUnsupportedHint:'このプラットフォームにはコンピュータ操作のバックエンドがないため、この機能は利用できません。',
          settingsStoppedHint:'コンピュータ操作は停止中です。オフにしてから再度オンにすると、アシスタントの操作を再開できます。',
          bannerTitle:'アシスタントがコンピュータを操作中です',
          bannerNote:'アシスタントは画面を確認し、マウスとキーボードを操作できます。いつでも停止できます。',
          bannerStop:'操作を停止',
          grantTitle:'アシスタントがコンピュータの操作を求めています',
          grantDesc:'許可すると、このセッションでアシスタントが画面を確認し、マウスとキーボードを操作できます。現在のタスクを信頼できる場合のみ許可してください。重要な操作は引き続き都度確認されます。',
          grantAllow:'このセッションの操作を許可',
          grantDeny:'拒否',
          ...
          confirmOnce:'今回のみ許可',
          confirmDeny:'拒否',
          fullTextWarning:'アシスタントはこのテキストをそのまま入力します。',
          textTooLongToPreview:'テキストが長すぎるため、全文をプレビューできません',
          buttonName:{ left:'左', right:'右', middle:'中' },
          confirmClick1:'クリック', confirmClick2:'ダブルクリック', confirmClick3:'トリプルクリック',
          confirmClick:(button, verb)=>`${button}${verb}`,
          confirmClickAt:(button, verb, point)=>`${point} で${button}${verb}`,
          confirmTypeCount:count=>`${count} 文字を入力`,
          ...
          confirmHoldKeyMasked:(chord, count, ms)=>chord?`${chord} + マスクされた${count}文字を ${ms} ミリ秒押す`:`マスクされた${count}文字を ${ms} ミリ秒押す`,
        ...
        uiMultiAgent: {
          ...
          roleCards:{ scout:'調査エキスパート', manager:'計画エキスパート', builder:'実行エキスパート', reviewer:'レビューエキスパート', general:'汎用エキスパート' },
        ...
        uiProjects: { convertToProject:'プロジェクトに変換', projectNamePlaceholder:'プロジェクト名', renameProject:'プロジェクトの名前を変更', deleteProject:'プロジェクトを削除', deleteConfirmLabel:'このプロジェクトを削除しますか？', deleteProjectHint:'会話は削除されず、未分類に戻ります', moveToProject:'プロジェクトへ移動…', moveToUngrouped:'未分類へ移動', alreadyUngrouped:'未分類です', folderUnavailable:'フォルダー利用不可', rebindFolder:'再バインド', moveConfirmTitle:'このプロジェクトへ会話を移動しますか？', moveConfirmBody:(project, folder)=>`会話は「${project}」に移動します。フォルダー ${folder} はプロジェクトに追加されず、会話のみが整理されます。`, moveConfirm:'移動', searchPlaceholder:'プロジェクトを検索', noProjects:'プロジェクトはまだありません', currentProject:'現在のプロジェクト', movedNotice:'会話を移動しました', movedNoticeWithFolder:folder=>`会話を移動し、フォルダー ${folder} をプロジェクトに追加しました（この会話のアクセス範囲は変わりません）`, noMatchProject:'一致するプロジェクトがありません', opFailed:'プロジェクト操作に失敗しました' , manageFolders:'フォルダーを管理', newSessionHere:'新しい会話', rebindTitle:'プロジェクトフォルダーを再バインド', rebindConfirm:'移動して再バインド', rebindSessionsHint:()=>'このフォルダー配下のすべての会話が新しいディレクトリに切り替わります', rebindSuccess:n=>`${n} 件の会話を再バインドしました`, rebindUpToDate:'再バインドが必要な会話はありませんでした', rebindOldExistsWarn:'元のフォルダーがまだ存在します。切り替えると 2 か所が別々のディレクトリを指します。続行しますか？', rebindPartial:(ok, failed)=>`${ok} 件を再バインドし、${failed} 件が失敗しました。残りは再試行できます`, rebindBusyAfter:n=>`${n} 件の会話が再バインド中に新しいターンを開始しました。異常があればアイドル後に再試行してください` , rebindRetryRemaining:'残りを再試行', rebindFailedSessions:'失敗した会話', rebindInProgress:'別のフォルダー再バインドが実行中です' , rebindBusyHint:'これらのセッションはターン実行中です。アイドルになってから再試行してください', rebindToRoot:'ファイルシステムのルートは指定できません。通常のフォルダーを選択してください', rebindToNested:'新しいフォルダーを元のフォルダー内に置くことはできません', rebindToUnusable:'選択したフォルダーは使用できません。別のフォルダーを選択してください', rebindRootsConflict:'そのフォルダーはプロジェクト自身のフォルダーと入れ子になります。既存フォルダーの外側を選択してください', rebindRootsExpand:'すべての失効フォルダーを表示', rebindRootsCollapse:'最初の失効フォルダーのみ表示' },
        uiKeychain: { accessibleFolders:n=>`アクセス可能な ${n} 個のフォルダー`, accessibleFoldersRecorded:n=>`記録済みのフォルダー ${n} 件（現在有効なのはメインのみ）`, primaryBadge:'主', unknownDirectory:'不明なディレクトリ', alignAction:'プロジェクトに合わせる', alignActionDesc:'この会話のアクセス可能フォルダーをプロジェクトの現在のセットに更新します（次のターンから有効）', alignActionDescRecorded:'この会話に記録されたフォルダーセットを更新します（追加ルートはまだ外部エージェントに届かず、メインのみ有効）', alignDone:'プロジェクトに合わせました', alignNoChange:'すでに最新です', alignNoProject:'このセッションはフォルダーを持つプロジェクトに属していないため、整列できません', alignBusy:'現在のターン終了後に再試行してください', alignWriteSkipped:'ディスクは変更されていません（書き込みが反映されず）。実行中のセッションは中断していないため、再試行できます', alignFailed:'プロジェクトに合わせる操作に失敗しました' },
        uiManageFolders: { title:'フォルダーを管理', renameHint:'クリックでプロジェクト名を変更', emptyRoots:'このプロジェクトにはフォルダーがありません（ラベルのみ）', primaryBadge:'主', setPrimaryHint:'主フォルダーに設定', removeAction:'削除', removeConfirm:'削除', removeConfirmBody:'進行中の会話は終了までこのフォルダーへのアクセスを保持し、セッションを削除するまでキーチェーンにフォルダーが残り、再起動後も有効です。今後の新しい会話には付与されません。明示的に整理された会話はそのまま。自動グループの会話は未分類に移動します。', removePrimaryBlocked:'これは主フォルダーです：先に別のフォルダーを主に設定してから削除してください。', addAction:'フォルダーを追加…', addDuplicate:'このフォルダーはすでにプロジェクトにあります', addNested:'このフォルダーはプロジェクトの既存フォルダーの内側、またはその上位にあります。1 つのプロジェクト内でフォルダーを入れ子にはできません', addNoticeRestricted:'追加後、このプロジェクトの新しい会話はこのフォルダーにアクセスできます', addNoticeVisibility:'追加後、新しい会話ではこのフォルダーがプロジェクトに属することがモデルに伝わります', exclusionSection:'自動プロジェクト化を除外するフォルダー', neverMaterializeAction:'自動プロジェクト化を停止', neverMaterializeHint:'このフォルダーを除外リストに追加します：今後自動でプロジェクト化されません（このプロジェクトと既存の会話には影響しません）', revokeExclusion:'取り消す', exclusionDone:'除外リストを更新しました' },
        uiWorkspacePicker: { title:'ワークスペースを選択', searchPlaceholder:'プロジェクトやパスを検索', empty:'プロジェクトはまだありません。フォルダーを参照するか、一時チャットを開始できます', noMatch:'一致するプロジェクトがありません', multiRootSummary:(n, primary)=>`${n} 個のフォルダー · 既定: ${primary}`, primaryRootBadge:'既定', noticeRestricted:n=>`この会話は ${n} 個のフォルダーにアクセスできます`, noticeVisibility:n=>`この ${n} 個のフォルダーがこの会話に関連していることがモデルに伝わります`, noticeRestrictedRecorded:n=>`${n} 個のフォルダーを記録します（現在有効なのはメインのみ）`, noticeVisibilityRecorded:n=>`この ${n} 個のフォルダーを会話に記録します（現在有効なのはメインのみ）`, temporary:'一時チャット', temporaryDesc:'ディレクトリに紐付けません', browse:'他のフォルダーを参照…', browseDesc:'選択したフォルダーを起点に新しい会話を開始', excludedTitle:'このフォルダーの自動プロジェクト化はオフです', excludedBody:name=>`「${name}」は除外リストに入っているため、自動でプロジェクト化されません。より広いプロジェクトがルート一致で会話を自動整理する可能性はあります。このフォルダーで通常の会話を始めることはできます。`, excludedProceed:'それでもこのフォルダーで開始', unknownDirectory:'不明なディレクトリ' },
        ...
        feedbackTitle: 'ヘルプとフィードバック', feedbackDesc: '問題や提案をスクリーンショットや短い動画付きで送信できます。',
         feedbackDialogTitle: 'フィードバック', feedbackType: '種類',
        ...
        queueMsg: '現在の会話に送信', queueMsgTip: '生成中：テキストは可能ならこのターンに注入（不可時はキュー）、添付は常にキュー',
        ...
        voiceEmptyResultTitle: '音声を認識できませんでした', voiceEmptyResultHint: 'マイクに近づくか、静かな場所でもう一度お試しください。',
         
        voiceEditPostprocessing: '現在の入力を編集しています…',  
        voiceEditPreviewTitle: '音声編集プレビュー',
        voiceEditOriginal: '元の文', voiceEditResult: '編集後', voiceEditApply: '変更を適用',
        voiceEditApplyAndSend: '適用して送信', voiceEditCancel: '編集をキャンセル',
        voiceIntroTitle: '音声入力の使い方',
        voiceIntroClose: '音声ショートカット案内を閉じる',
        voiceIntroShortcutLabel: 'ショートカット',
        voiceIntroComboLabel: 'テキストあり',
        voiceIntroModeLabel: 'モード',
        voiceIntroDictationMode: '音声入力',
        voiceIntroDictationSteps: ['Alt で録音開始', 'もう一度 Alt で録音終了', 'テキストを入力欄に挿入して編集できます'],
        voiceIntroTaskMode: '音声編集',
        voiceIntroTaskSteps: ['入力欄にテキストがある時に Alt で録音開始', 'もう一度 Alt で録音終了', '編集後のテキストを確認して送信できます（スマート整理のオンが必要。オフのときはこの操作で文字起こしのまま）'],
        voiceIntroTaskExampleLabel: '編集例',
        voiceIntroTaskExample: '「これを3つの要点にして、少し丁寧な表現にして。」',
        voiceIntroGotIt: '今は有効化せず続ける',
        voiceIntroDone: '了解',
        voiceIntroStart: '了解、音声入力を開始',
        voiceIntroEnable: '有効化して続ける',
        voiceShortcutEnableTitle: '音声ショートカットを有効化',
        composerTools: 'ツール', composerModelLabel: name => `モデル：${name}`,  composerConnected: '接続済み',     composerManageTools: 'ツール管理',
         composerModeNone: '利用可能なスキルなし',
        composerBuiltinAuto: '内蔵 · 自動', composerSkillInUse: '使用中', composerSkillAllDisabled: 'このセッション種別の全スキルがオフです。上で有効にできます',  composerReadonlySwitch: 'モードで制御され、手動で切り替え不可',
        ...
        handled: '処理済み',
        stuckReplan: '📋 AI にプランを出し直させる',  stuckGo: 'そのまま実行（プランを省略）',
        // 品悟レビューカード。品/悟 の字はブランド表記として保持、周囲の文言は言語に追従。
        pvLoadingPin: 'Pinvou 品 · レビュー', pvLoadingWu: 'Pinvou 悟 · 発散補完',
        ...
        pvBtnPinTitle: '品 · レビュー：成果物のリスク・抜け漏れ・要求とのズレを洗い出し、AI に修正させるか受け入れる',
        pvBtnWuTitle: '悟 · 発散：専門家視点で成果物に補える観点や新案を提示、選んだものをワンクリックで追加',
        pvBtnPinLabel: '品 · レビュー', pvBtnWuLabel: '悟 · 発散',
        ...
        apEmpty: '成果物はまだありません',   
         apMissing: 'ファイルが存在しないか削除されています', apReadFail: e => `読み込みに失敗: ${e}`,
        ...
        apConverting: 'プレビューを生成中…',  apUnsupported: 'この形式は埋め込みプレビュー非対応。下の「開く」をご利用ください',
...
Object.assign(dictJa.uiToolDetails.tools, {
  ...
  'tencent-docs':{ title:'Tencent Docs MCP', subtitle:'公式リモート MCP：オンラインドキュメント・表・スライドの読み書きとコラボレーション', latency:'クラウド', desc:'Tencent Docs 公式リモート MCP（汎用ドキュメント + PPT/Word/Excel 個別編集の 4 サービス）に接続：本人アカウントでオンラインドキュメント、表計算、スライド、マインドマップ、スマートシートの作成・閲覧・編集、ナレッジベース空間とファイルの管理、ウェブクリップやローカルファイルのクラウドアップロードに対応します。インストール時に公式 Skill（シナリオルーティング + ツール API リファレンス）も自動設定されます。Tencent Docs 個人 Token（公式ページで QQ/WeChat の QR コードで取得）が必要です。Token はこの端末のシステム認証情報にのみ保存されます。', configTitle:'Tencent Docs に接続', configDescription:'Token はこの端末のシステム認証情報にのみ保存され、mcp.json に書き込まれず、会話にも入りません。', configDocLabel:'Tencent Docs の Token を取得', configFields:[{key:'TENCENT_DOCS_TOKEN', label:'個人 Token', helpText:'認証ページを開き、QQ または WeChat の QR コードでログイン後 Token をコピーしてください。Bearer プレフィックスは付けないでください。', placeholder:'Tencent Docs 個人 Token を貼り付け'}], welcomeQueries:['最近の Tencent Docs を一覧表示','この週報を Tencent スマートドキュメントとして作成','収支を記録するオンライン表計算を作成','この Tencent Docs の表計算を読んで分析'] },
  ...
  dingtalk:{ title:'DingTalk', subtitle:'本人として DingTalk のドキュメント、カレンダー、表、メッセージを操作', type:'CLI + 公式 Skill', latency:'クラウド', desc:'DingTalk 公式 DingTalk Workspace CLI（dws、Apache-2.0）と公式 Skill に接続：AI が本人として DingTalk ドキュメントの読み書き、カレンダーの確認・変更、AI テーブル・オンラインシートの操作、グループメッセージの送受信、ToDo・承認・日誌・メールの処理を行えます。「接続」を押して DingTalk アプリで QR コード認証。キー入力は不要です。', welcomeQueries:['DingTalk ドキュメントを読む','今日の DingTalk スケジュールを確認','DingTalk AI テーブルのデータを照会','DingTalk の ToDo を表示'] },
  ...
  obsidian:{ title:'Obsidian ナレッジベース', subtitle:'ローカルの Obsidian ノートを検索・管理。個人の知識を読み書き', desc:'ローカルの Obsidian ノートの保管庫（vault）を大規模モデルに接続します。全文検索、閲覧、新規作成、編集、名前変更（双方向リンクを自動修正）、削除に対応し、AI があなたの蓄積した知識を活用・維持できます。現在開いている vault を自動認識するため手動設定は不要。ノートもモデルも端末内にあり、知識と計算は端末の外に出ません。', welcomeQueries:['ノートを検索','今日の考えを記録するノートを作成','ナレッジベースにあるドキュメント一覧は？','ノートを要約'] },
...
dictJa.uiChatView = {
  ...
  placeholderScenePpt:'生成したい PPT のテーマや修正内容を記述してください',
...
failure: 'PPT 生成機能の準備に失敗しました。しばらくしてからもう一度お試しください。',
  ...
  workbenchTemplates: {
    ...
    'task-board': 'タスクボード',
    'job-tracker': '就活管理',
    'travel-planner': '旅行プラン',
    'fitness-checkin': '運動チェックイン',
  },
};

Object.assign(dictJa.uiScheduled, {
  createFromChat: 'AI チャットで作成',
  chooseHour: '時を選択',
  chooseMinute: '分を選択',
  daySeparator: '、',
  previewTasks: {
...
dictJa.uiArtifacts = {
  ...
  diFontYaHei:'Microsoft YaHei', diFontPingFang:'PingFang SC', diFontSimSun:'SimSun', diFontSimHei:'SimHei', diFontKaiTi:'KaiTi', diFontFangSong:'FangSong', diFontSourceHanSans:'Source Han Sans SC', diFontSourceHanSerif:'Source Han Serif SC',
  ...
  diChangeGroupEdit:'編集', diChangeGroupTextEdit:'テキスト編集', diChangeGroupResize:'サイズ変更', diChangeGroupMove:'移動', diChangeTypeText:'テキスト',
...
desktopHint:'先にデスクトップで Obsidian をインストールして保管庫を作成し、ここで再検出してください。',
  ...
  uploadSkillPackage:'プラグインパッケージをアップロード', dropSkillZipHere:'ドロップでプラグインパッケージ (zip) またはスキルファイル (.md) をインポート', zipTooLarge:mb=>`ファイルが ${mb}MiB の上限を超えています`, visibilityLoadFailed:'表示設定の読み込みに失敗しました。再試行してください（保存済みの設定は変更されません）。',
  ...
  openBrowserFailed:'ブラウザーを開けませんでした。もう一度お試しください',
...
visualizer: { title:'データ分析の可視化', subtitle:'Chart.js ダッシュボード / グラフ分析 / HTML 可視化', desc:'構造化データ・表の集計・ビジネス指標を、Pinvou のホスト体験に合った HTML 可視化ダッシュボードに変換します。デフォルトで Chart.js、アクセシブルな canvas、カスタム凡例、フラット配色を使用し、.html 成果物カードとして提供します。', latency:'ローカル' },
...
Object.assign(dictJa.uiToolStore, {
  ...
  typeGroups:{ bundle:'プラグインパッケージ', mcp:'MCP', skill:'スキル', cli:'CLI 連携', api:'API & Webhook', upcoming:'近日公開' },
...
Object.assign(dictJa.uiSettingsDetail, {
  ...
  reasoningProbePending:'サーバータイプを検出中…', reasoningProbeUnsupported:'このエンドポイントは思考の深さの調整をサポートしていません',
  reasoningThinkingAlwaysOn:'このモデルは常に思考を行い、オフにできません',
  saving:'保存中', localDetectionTargets:'vLLM、Ollama、LM Studio などのローカルサービスを検出',
  redetect:'再検出', detect:'検出', noRunningLocalModel:'実行中のローカルモデルが見つかりません', localPortLabel:'ポート', localPortPlaceholder:'例: 8080', localPortInvalid:'ポートが無効です：1〜65535 の数値を入力してください', modelNotLoadedTag:'未読み込み', modelNotLoadedHint:'メモリ未読み込み。初回使用時に自動でロードされます',
...
Object.assign(dictJa.uiSettingsDetail.modelDescriptions, { '本地服务默认模型': 'ローカルサービスのデフォルトモデル', 'Coding Plan 自动模型': 'Coding Plan 自動モデル', '自动模型，智能路由': '自動モデル（スマートルーティング）', 'Hy 套餐专属模型': 'Hy プラン専用モデル', '标准编码模型': '標準コーディングモデル', 'K3 长上下文模型': 'K3 長コンテキストモデル', '高速编码模型': '高速コーディングモデル', 'K3 256K 上下文，价格更低': 'K3 256K コンテキスト、より低価格', '官方已转 Legacy，兼容保留': '公式レガシー化済み。互換性のため保持', '官方已转 Legacy，兼容高速': '公式レガシー化済み。高速互換', '最新旗舰': '最新フラッグシップ', '上代旗舰推理': '前世代フラッグシップ推論', '均衡性价比': 'バランス型で高コストパフォーマンス', '快速高性价比': '高速で高コストパフォーマンス', '旗舰推理与编码': 'フラッグシップ推論とコーディング', '均衡智能与成本': '知能とコストのバランス', '低成本高并发': '低コスト・高スループット', '上代旗舰': '前世代フラッグシップ', '快速经济': '高速で経済的', '速度与智能均衡': '速度と知能のバランス', '最新 Flash，均衡高性价比': '最新 Flash、バランス型で高コストパフォーマンス', '旗舰推理（预览）': 'フラッグシップ推論（プレビュー）', '旗舰编码模型，全套餐支持': 'フラッグシップコーディングモデル、全プラン対応', '原生多模态编码模型，额度三倍': 'ネイティブマルチモーダルコーディングモデル、利用枠3倍', '历史模型，请求自动切换至 GLM-5.3': 'レガシーモデル、リクエストは GLM-5.3 に自動切替', '历史模型，自动切换至 GLM-5.3-Flash': 'レガシーモデル、GLM-5.3-Flash に自動切替', '历史模型，请求自动路由至 GLM-5.3': 'レガシーモデル、リクエストは GLM-5.3 に自動ルーティング', '历史模型，自动路由至 GLM-5.3-Flash': 'レガシーモデル、GLM-5.3-Flash に自動ルーティング', '旗舰编码模型，官方将于 2026-10-09 下线': 'フラッグシップコーディングモデル、2026-10-09 に提供終了予定', '官方将于 2026-10-09 下线': '2026-10-09 に提供終了予定', '通用推理，官方将于 2026-10-09 下线': '汎用推論、2026-10-09 に提供終了予定', '多模态高性价比': 'マルチモーダルで高コストパフォーマンス', '最新多模态高性价比': '最新マルチモーダル、高コストパフォーマンス', 'Kimi 最新旗舰': 'Kimi 最新フラッグシップ', 'Kimi 编码模型': 'Kimi コーディングモデル', 'MiniMax 最新旗舰': 'MiniMax 最新フラッグシップ', 'Hy4 预览，高峰期可能限频': 'Hy4 プレビュー、混雑時はレート制限の可能性あり', 'V4.1-Flash 主力，1M 上下文，支持图片输入': 'V4.1-Flash の主力モデル。1M コンテキスト、画像入力対応', '在售；官方确认 2026-09-14 后继续提供且计费不变': '販売中。公式に 2026-09-14 以降も提供継続・課金は変更なし', '最新旗舰，强制思考': '最新フラッグシップ、思考は常時オン', '最新旗舰，1M 上下文多模态': '最新フラッグシップ、1M コンテキスト・マルチモーダル', '最新旗舰，1M 上下文': '最新フラッグシップ、1M コンテキスト', '全模态理解（图片/视频）': '全モーダル理解（画像・動画）', '上代旗舰推理（纯文本）': '前世代フラッグシップ推論（テキストのみ）', '上代快速款': '前世代の高速モデル', '正式旗舰，夜间 22:00-08:00 五折（个人版）': '正式フラッグシップ、22:00-08:00 は半額（個人版）', '轻量兼容款，支持图像输入': '軽量互換モデル、画像入力対応', '快速响应，暂不支持 Responses API': '高速応答、Responses API は未対応', '最新推荐，周级滚动升级': '最新の推奨モデル、週次ローリング更新', '低成本低时延，效果比肩 2-1-pro': '低コスト・低レイテンシ、2-1-pro に匹敵', '编程特化（预览）': 'コーディング特化（プレビュー）', '最强旗舰；仅 Responses 协议支持函数调用': '最強フラッグシップ。関数呼び出しは Responses API のみ', 'GPT-5.6 家族旗舰，推理与编码': 'GPT-5.6 ファミリーのフラッグシップ、推論とコーディング', '最强旗舰，高难推理与长程 Agent': '最強フラッグシップ、高難度推論と長時間エージェント', '上代旗舰，兼容保留': '前世代フラッグシップ、互換性のため保持', '复杂 Agent 编码，默认推荐': '複雑なエージェントコーディング、デフォルト推奨', '最快，200K 上下文': '最速、200K コンテキスト', '上一代 Flash': '前世代 Flash', '基线速度，兼容保留': 'ベースライン速度、互換性のため保持', '旗舰，编码与 Agent 默认推荐': 'フラッグシップ、コーディングと Agent のデフォルト推奨', '上代旗舰，编码与 Agent': '前世代フラッグシップ、コーディングと Agent', '4.20 推理，1M 上下文': '4.20 推論、1M コンテキスト', '4.20 非推理，1M 上下文': '4.20 非推論、1M コンテキスト', '快速可靠，强工具调用': '高速で安定、ツール呼び出しに強い', '代码 Agent，256K 上下文': 'コーディングエージェント、256K コンテキスト'
});
