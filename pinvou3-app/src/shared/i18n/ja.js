...
Object.assign(dictJa.uiAttachments, {
  ...
  localEngineInstallPrompt:'ローカル画像認識エンジンが未インストールです。今すぐインストールしますか？ 設定→モデル→ローカル画像認識でもインストール/アンインストールできます。',
  localEngineInstallConfirm:'インストールして続行', localEngineInstallCancel:'今はしない',
  localEngineNotRunningPrompt:'ローカル画像認識エンジンが起動しておらず、自動起動は「しない」に設定されています。',
  localEngineGoSettings:'設定から起動', localEngineSendFallback:'今回だけクラウドのビジョンモデルで送信',
...
dictJa.uiSettingsDetail.llamaEngine = {
  title:'ローカルマルチモーダルエンジン',
  introWhatLabel:'機能', introWhat:'オープンソースの視覚モデル（Qwen3-VL）をこの端末で実行します。画像解析はすべてローカルで行われ、アップロードされません。',
  introWhenLabel:'いつ使う', introWhen:'使用中のチャットモデルが画像入力に対応していない場合、または画像をクラウド事業者に送信したくない場合。',
  introHowLabel:'有効化', introHow:'下でエンジンとモデルをダウンロードしてサービスを起動します。「画像認識の自動フォールバック」をオンにしておくと、画像受信時に自動でローカルエンジンが解析します。',
  introPerfLabel:'性能', introPerf:'認識速度は端末の性能に依存します。高性能な GPU または CPU を搭載した PC での利用をおすすめします。初回のモデル読み込みには時間がかかります。',
  setupSection:'インストールとモデル', behaviorSection:'動作', engineReady:'エンジンがインストール済み', engineMissing:'エンジン未インストール',
  modelReady:'モデル準備完了', modelMissing:'モデル未ダウンロード', running:'実行中', starting:'起動中…', stopped:'停止済み',
  runningWithPort:port=>`実行中（127.0.0.1:${port}）`,
  downloadingEngine:'エンジンをダウンロード中', downloadingModel:'モデルをダウンロード中', cancelDownload:'キャンセル',
  engineLabel:'エンジン', modelLabel:'ビジョンモデル', deviceLabel:'デバイス', serviceLabel:'サービス',
  installEngine:'エンジンをダウンロード（約 40MB）', installModel:'ダウンロード', gpu:'GPU（Vulkan / Metal）', cpu:'CPU',
  deviceAuto:'自動', deviceAutoGpu:'利用可能な GPU を検出しました', deviceAutoCpu:'利用可能な GPU が見つかりません。CPU を使用します',
  recommended:'おすすめ', default:'デフォルト', start:'エンジンを起動', stop:'エンジンを停止', deleteModel:'削除', deleteEngine:'アンインストール',
  deleteRequiresStop:'エンジン実行中です。先にエンジンを停止してから削除してください',
  deleteEngineConfirm:tag=>`ローカルエンジン${tag ? `（v${tag}）` : ''}をアンインストールします。モデルファイルは保持され、エンジン再インストール後にそのまま使えます。実行しますか？`,
  restartApply:'再起動して適用', restartNeeded:'モデルの変更はエンジンの再起動後に有効になります',
  deleteModelConfirm:name=>`「${name}」のローカルモデルファイルを削除します。必要になったら再ダウンロードできます。削除しますか？`,
  viewLogs:'ログを表示', privacyNote:'127.0.0.1 のみで待ち受け。モデルと画像は端末から離れません。',
  newSessionHint:'エンジン起動後、新しい会話でローカルのビジョン機能が使えます。',
  visionFallbackLabel:'画像分析の自動フォールバック',
  visionFallbackDesc:'有効時、ビジョンモデル未設定のテキストのみのモデルは、画像をローカルエンジンで解析します。ビジョンモデルまたは「ローカル画像認識エンジン」を明示設定したモデルは、それぞれの設定が優先され、横取りされません。',
  localEngineOption:'ローカル画像認識エンジン', autoStartLabel:'エンジンの自動起動', autoStartFirstImage:'初回の画像送信時',
  autoStartLaunch:'pinvou 起動時', autoStartNever:'自動起動しない',
  autoStartFirstImageDesc:'普段はゼロ負荷。初回の画像送信時に起動するため、最初の認識はモデル読み込み待ちになります',
  autoStartLaunchDesc:'アプリ起動時にバックグラウンドで事前起動。すぐに認識できますが、エンジンがメモリに常駐します',
  autoStartNeverDesc:'自動起動しません。このページで手動起動するか、画像送信時に選択できます',
