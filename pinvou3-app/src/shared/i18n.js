...
const dict = {
      zh: {
        langTag: 'zh',
        newChat: '新对话', currentChat: '当前对话', searchChats: '搜索对话', monitor: '运行状态', workflow: '工作流', toolStore: '工具商店', cardPool: '专家卡牌池', recent: '历史对话', pinnedTasks: '置顶任务', regularTasks: '任务', settings: '设置', localEnv: '本地环境', megacubeSite: '打开 MegaCube 官网', tearoffTitle: '撕离窗口', tearoffHint: '弹出为独立窗口',
        ...
        sysStatus: '运行状态', sysDesc: '模型运行监控', gpu: '图形处理器 (GPU)', gpuUnavail: '状态不可用', noSmi: '未检测到 nvidia-smi',
        ...
        depInstalling: '安装中…', depInstallBtn: '一键安装', depInstallNote: '将提权安装缺失依赖（需联网或可用 apt 源）',
        ...
        vllmSetupTitle: '启用本地大模型', vllmSetupDesc: '检测到本机已预装本地大模型环境，是否现在启用？将拉起推理引擎并配置为开机自启，随后自动设为默认模型。',
        ...
        vllmStepAuth: '授权并启动引擎', vllmStepWait: '等待模型加载就绪', vllmStepReady: '完成',
        ...
        riGenerating: '正在生成中', riDelQ: '删除?', riDelConfirm: '确认删除', riOpenFolder: '打开文件夹', riMore: '更多', riRename: '重命名', riPin: '置顶', riUnpin: '取消置顶',
        // —— 聊天链路/全局 chrome ——
        appTitle: 'PINVOU 智能助手', winMin: '最小化', winMax: '最大化', winClose: '关闭',
        sidebarCollapse: '收起侧边栏', sidebarExpand: '展开侧边栏',
        skillPrefill: name => `我要用 ${name} 完成: `,
        queuedTag: '排队中', queuedCancel: '撤销',
        attachParsing: '解析中…', attachFailed: '失败', attachAdd: '添加附件',
        ...
        composerTools: '工具', composerInstalledTools: '已接入工具', composerNoTools: '暂无已装工具', composerToolOn: '已启用', composerManageTools: '管理工具',
        composerMode: '技能', composerModeTitle: '技能', composerModeNone: '暂无可用技能',
        composerSkillAuto: '内置·自动', composerSkillInUse: '使用中', composerSkillSoon: '待上线',
        ...
        toolRunning: '运行中...', toolDone: '完成', toolFailed: '失败',
      ...
      en: {
        langTag: 'en',
        newChat: 'New chat', currentChat: 'Current chat', searchChats: 'Search chats', monitor: 'Runtime', workflow: 'Workflow', toolStore: 'Tool Store', cardPool: 'Card Deck', recent: 'History', pinnedTasks: 'Pinned tasks', regularTasks: 'Tasks', settings: 'Settings', localEnv: 'Local Env', megacubeSite: 'Open MegaCube site', tearoffTitle: 'Detached', tearoffHint: 'Pop out to its own window',
        ...
        sysStatus: 'Runtime Status', sysDesc: 'Model runtime monitor', gpu: 'GPU', gpuUnavail: 'Unavailable', noSmi: 'nvidia-smi not found',
        ...
        depInstalling: 'Installing…', depInstallBtn: 'Install', depInstallNote: 'Installs missing deps via elevated apt (needs network or an apt source)',
        ...
        vllmSetupTitle: 'Enable Local Model', vllmSetupDesc: 'A local model environment is pre-installed on this machine. Enable it now? This starts the inference engine, sets it to auto-start on boot, and makes it the default model.',
        ...
        vllmStepAuth: 'Authorize & start engine', vllmStepWait: 'Waiting for model to load', vllmStepReady: 'Done',
        ...
        riGenerating: 'Generating…', riDelQ: 'Delete?', riDelConfirm: 'Confirm delete', riOpenFolder: 'Open folder', riMore: 'More', riRename: 'Rename', riPin: 'Pin', riUnpin: 'Unpin',
        // —— Chat & global chrome ——
        ...
        attachParsing: 'Parsing…', attachFailed: 'Failed', attachAdd: 'Attach file',
        ...
        composerTools: 'Tools', composerInstalledTools: 'Connected tools', composerNoTools: 'No tools installed', composerToolOn: 'On', composerManageTools: 'Manage tools',
        composerMode: 'Skill', composerModeTitle: 'Skills', composerModeNone: 'No skills available',
        composerSkillAuto: 'Built-in', composerSkillInUse: 'In use', composerSkillSoon: 'Soon',
        ...
        toolRunning: 'Running...', toolDone: 'Done', toolFailed: 'Failed',
      ...
      ja: {
        langTag: 'ja',
        newChat: '新しいチャット', currentChat: '現在のチャット', searchChats: 'チャットを検索', monitor: '稼働状態', workflow: 'ワークフロー', toolStore: 'ツールストア', cardPool: 'カードプール', recent: '履歴', pinnedTasks: '固定タスク', regularTasks: 'タスク', settings: '設定', localEnv: 'ローカル環境', megacubeSite: 'MegaCube サイトを開く', tearoffTitle: '切り離し', tearoffHint: '別ウィンドウに切り離す',
        ...
        sysStatus: '稼働状態', sysDesc: 'モデル実行モニター', gpu: 'GPU', gpuUnavail: '状態を取得できません', noSmi: 'nvidia-smi が見つかりません',
        ...
        depInstalling: 'インストール中…', depInstallBtn: 'インストール', depInstallNote: '権限昇格して不足依存をインストール（ネットワークまたは apt ソースが必要）',
        ...
        vllmSetupTitle: 'ローカルモデルを有効化', vllmSetupDesc: 'この端末にローカルモデル環境がプリインストールされています。今すぐ有効化しますか？推論エンジンを起動し、起動時の自動起動を設定して、既定モデルにします。',
        ...
        vllmStepAuth: 'エンジンを認可・起動', vllmStepWait: 'モデルの読み込みを待機', vllmStepReady: '完了',
        ...
        riGenerating: '生成中…', riDelQ: '削除?', riDelConfirm: '削除を確認', riOpenFolder: 'フォルダーを開く', riMore: 'その他', riRename: '名前を変更', riPin: 'ピン留め', riUnpin: 'ピン留め解除',
        // —— チャット/グローバル chrome ——
        ...
        attachParsing: '解析中…', attachFailed: '失敗', attachAdd: 'ファイルを添付',
        ...
        composerTools: 'ツール', composerInstalledTools: '接続済みツール', composerNoTools: 'ツールなし', composerToolOn: '有効', composerManageTools: 'ツール管理',
        composerMode: 'スキル', composerModeTitle: 'スキル', composerModeNone: '利用可能なスキルなし',
        composerSkillAuto: '内蔵', composerSkillInUse: '使用中', composerSkillSoon: '近日',
        ...
        toolRunning: '実行中...', toolDone: '完了', toolFailed: '失敗',
