...
const dict = {
      zh: {
        ...
        uiPetSettings: { choose:'选择公仔', placeholder:'开发占位', preparing:'正在准备动画', animationFailed:'动画加载失败', coverFailed:'封面加载失败', retry:'重试', pets:{ lingling:{name:'灵灵',description:'星纹卷尾，灵动相伴'}, langlang:{name:'浪浪',description:'黑衫眼镜，从容同行'}, 'ace-taffy':{name:'Ace Taffy',description:'粉发皇冠，元气应援'}, vivi:{name:'Vivi',description:'蓝衣长发，温柔相伴'} } },
      ...
      ja: {
        ...
        uiPetSettings: { choose:'コンパニオンを選択', placeholder:'開発中', preparing:'アニメーションを準備中', animationFailed:'アニメーションの読み込みに失敗', coverFailed:'カバーの読み込みに失敗', retry:'再試行', pets:{ lingling:{name:'リンリン',description:'星模様の巻き尾で、軽やかに寄り添います'}, langlang:{name:'ランラン',description:'黒い服と眼鏡で、落ち着いて寄り添います'}, 'ace-taffy':{name:'Ace Taffy',description:'ピンクの髪と王冠で元気に応援します'}, vivi:{name:'Vivi',description:'青いジャケットで、優しく寄り添います'} } },
