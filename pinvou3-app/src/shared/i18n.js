...
const dict = {
      zh: {
        ...
        depInstalling: '安装中…', depInstallBtn: '一键安装', depGoInstall: '去安装', depInstallNote: '将提权安装缺失依赖（需联网或可用 apt 源）', depInstallNoteWindows: '将通过 winget 提权安装 LibreOffice（需联网）', depInstallNoteMac: '将通过 Homebrew 安装缺失依赖（需联网；若未安装 Homebrew，请先到 brew.sh 安装）',
      ...
      ja: {
        ...
        depInstalling: 'インストール中…', depInstallBtn: 'インストール', depGoInstall: 'インストール', depInstallNote: '権限昇格して不足依存をインストール（ネットワークまたは apt ソースが必要）', depInstallNoteWindows: 'winget を権限昇格して LibreOffice をインストール（ネットワークが必要）', depInstallNoteMac: 'Homebrew で不足依存をインストール（ネットワークが必要、Homebrew 未導入なら brew.sh から先にインストール）',
