...
const dict = {
      zh: {
        ...
        remoteKbJoinSource: '共享链接', remoteKbJoinSourcePlaceholder: '粘贴 pinvou-knowledge://share… 共享链接', remoteKbJoinHint: '仅支持所有者生成的共享链接；批准后会自动加入。', remoteKbShareLinkOnly: '请粘贴由所有者生成的 pinvou-knowledge://share… 共享链接。', remoteKbJoinRequested: '加入申请已发送', remoteKbPendingTitle: '等待加入确认', remoteKbPendingDesc: '批准后会自动加入。', remoteKbCancelRequest: '取消申请', remoteKbOwner: '所有者', remoteKbGovern: '管理', remoteKbGovernTitle: '共享与成员', remoteKbPeopleTab: '成员与邀请', remoteKbServiceTab: '服务与维护',
      ...
      en: {
        ...
        remoteKbJoinSource: 'Share link', remoteKbJoinSourcePlaceholder: 'Paste a pinvou-knowledge://share… link', remoteKbJoinHint: 'Only owner-generated share links are supported. PINVOU joins automatically after approval.', remoteKbShareLinkOnly: 'Paste a pinvou-knowledge://share… link generated by the owner.', remoteKbJoinRequested: 'Join request sent', remoteKbPendingTitle: 'Waiting for approval', remoteKbPendingDesc: 'PINVOU joins automatically after approval.', remoteKbCancelRequest: 'Cancel', remoteKbOwner: 'Owner', remoteKbGovern: 'Manage', remoteKbGovernTitle: 'Sharing and members', remoteKbPeopleTab: 'People and invites', remoteKbServiceTab: 'Service and maintenance',
      ...
      ja: {
        ...
        remoteKbJoinSource: '共有リンク', remoteKbJoinSourcePlaceholder: 'pinvou-knowledge://share… 共有リンクを貼り付け', remoteKbJoinHint: '所有者が作成した共有リンクのみ利用できます。承認後、自動的に参加します。', remoteKbShareLinkOnly: '所有者が作成した pinvou-knowledge://share… 共有リンクを貼り付けてください。', remoteKbJoinRequested: '参加申請を送信しました', remoteKbPendingTitle: '承認待ち', remoteKbPendingDesc: '承認後、自動的に参加します。', remoteKbCancelRequest: '申請を取消', remoteKbOwner: '所有者', remoteKbGovern: '管理', remoteKbGovernTitle: '共有とメンバー', remoteKbPeopleTab: 'メンバーと招待', remoteKbServiceTab: 'サービスと保守',
