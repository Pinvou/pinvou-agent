...
const dict = {
    ...
    dict.zh.uiChatView = {
      subtabs:{ 'document-writing':'公文写作', poster:'海报', 'data-visualization':'数据可视化', ppt:'PPT设计' },
      disabledReasons:{ ppt:'PPT 生成能力修复中' },
      comingSoon:'即将上线',
    ...
    dict.en.uiChatView = {
      subtabs:{ 'document-writing':'Document writing', poster:'Poster', 'data-visualization':'Data visualization', ppt:'PPT design' },
      disabledReasons:{ ppt:'PPT generation is under repair' },
    ...
    dict.ja.uiChatView = {
      subtabs:{ 'document-writing':'公文書作成', poster:'ポスター', 'data-visualization':'データ可視化', ppt:'PPTデザイン' },
      disabledReasons:{ ppt:'PPT 生成機能は修復中です' },
      comingSoon:'近日公開',
...
Object.assign(dict.zh.uiWorkflow, {
  ...
  log:{
    ...
    role:'角色', stage:'阶段', category:'类型', retry:'重试', reason:'原因', detail:'详情',
  },
  ...
  callsText:n=>`${n} 次调用`, fanoutProgress:(done,total,running)=>`${done}/${total} 页完成 · ${running} 个 SubAgent 在写`,
  ...
  aiQuestions:'🤔 AI 想问你几个问题', cancelled:'✕ 已取消', submitted:'✓ 已提交',
...
Object.assign(dict.en.uiWorkflow, {
  ...
  log:{
    ...
    role:'Role', stage:'Stage', category:'Category', retry:'Retry', reason:'Reason', detail:'Detail',
  },
  ...
  callsText:n=>`${n} calls`, fanoutProgress:(done,total,running)=>`${done}/${total} pages done · ${running} SubAgents writing`,
  ...
  aiQuestions:'🤔 The AI has a few questions for you', cancelled:'✕ Cancelled', submitted:'✓ Submitted',
...
Object.assign(dict.ja.uiWorkflow, {
  ...
  log:{
    ...
    role:'ロール', stage:'ステージ', category:'種別', retry:'リトライ', reason:'原因', detail:'詳細',
  },
  ...
  callsText:n=>`${n} 回呼び出し`, fanoutProgress:(done,total,running)=>`${done}/${total} ページ完了 · ${running} 個の SubAgent が実行中`,
  ...
  aiQuestions:'🤔 AI からいくつか質問があります', cancelled:'✕ キャンセル済み', submitted:'✓ 送信済み',
