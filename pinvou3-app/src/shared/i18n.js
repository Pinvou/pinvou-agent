...
const dict = {
      zh: {
        ...
        voiceStructuredMode: '整理成条目', voiceEditMode: '编辑当前输入', voiceStructuredPostprocessing: '正在整理成条目…',
        voiceEditPostprocessing: '正在编辑当前输入…', voiceEditPreviewReady: '语音编辑待确认', voiceEditApplied: '语音编辑已应用', voiceEditNoChange: '语音编辑未产生修改',
        voiceModeMenu: '语音模式', voiceContinueDictation: '继续语音输入', voiceEditPreviewTitle: '语音编辑预览',
        ...
        voiceIntroComboLabel: '组合键',
        voiceIntroModeLabel: '模式',
        voiceIntroDictationMode: '普通语音输入',
        voiceIntroDictationTitle: '按 Alt',
        voiceIntroDictationDesc: '按一次开始录音，再按一次结束；识别后会填入输入框，你可以继续编辑再发送。',
        voiceIntroDictationSteps: ['按 Alt 开始录音', '再按 Alt 结束录音', '文字填入输入框，可编辑后发送'],
        voiceIntroTaskMode: '直接发任务',
        voiceIntroTaskTitle: '按 Alt + Space',
        voiceIntroTaskDesc: '按一次开始录制任务，再按一次结束；识别后直接交给 Pinvou 执行。',
        voiceIntroTaskSteps: ['按 Alt + Space 开始录音', '再按 Alt + Space 结束录音', '识别后直接发送给 Pinvou 执行'],
        voiceIntroTaskExampleLabel: '示例任务',
        voiceIntroTaskExample: '“帮我整理昨天的会议纪要，提取待办事项，并生成项目进度表。”',
        voiceIntroTaskHint: '再次按 Alt + Space 结束并执行',
        voiceIntroGotIt: '暂不开启，继续语音',
        voiceIntroStart: '知道了，开始语音输入',
        voiceIntroEnable: '启用并继续',
        voiceShortcutEnableTitle: '启用快捷键唤醒语音',
        voiceShortcutEnableDesc: '开启后，Alt 填入输入框，Alt + Space 直接发送任务。',
      ...
      en: {
        ...
        voiceStructuredMode: 'Structure as list', voiceEditMode: 'Edit current input', voiceStructuredPostprocessing: 'Structuring voice text…',
        voiceEditPostprocessing: 'Editing current input…', voiceEditPreviewReady: 'Voice edit ready to review', voiceEditApplied: 'Voice edit applied', voiceEditNoChange: 'Voice edit made no changes',
        voiceModeMenu: 'Voice mode', voiceContinueDictation: 'Continue dictation', voiceEditPreviewTitle: 'Voice edit preview',
        ...
        voiceIntroComboLabel: 'Combo',
        voiceIntroModeLabel: 'Mode',
        voiceIntroDictationMode: 'Voice input',
        voiceIntroDictationTitle: 'Press Alt',
        voiceIntroDictationDesc: 'Press once to start recording, then press again to stop. The transcript is inserted into the input box for editing.',
        ...
        voiceIntroTaskMode: 'Direct task',
        voiceIntroTaskTitle: 'Press Alt + Space',
        voiceIntroTaskDesc: 'Press Alt + Space once to start recording a task, then press it again to stop. Pinvou runs the result directly.',
        voiceIntroTaskSteps: ['Press Alt + Space to start recording', 'Press Alt + Space again to stop', 'Pinvou sends and runs the recognized task directly'],
        voiceIntroTaskExampleLabel: 'Example task',
        voiceIntroTaskExample: '"Summarize yesterday’s meeting, extract action items, and create a project status table."',
        voiceIntroTaskHint: 'Press Alt + Space again to stop and run',
        ...
        voiceShortcutEnableDesc: 'Alt inserts into the input box. Alt + Space sends a task directly.',
      ...
      ja: {
        ...
        uiSettings: { common:'一般', system:'システム', general:'一般', model:'モデル', search:'検索', memory:'メモリ', permissions:'権限と環境', data:'データ管理', update:'更新', help:'ヘルプとフィードバック', appearance:'外観', language:'表示言語', languageDesc:'アプリの表示言語を切り替えます', theme:'テーマ', themeDesc:'ライトまたはダーク外観を選択', notifications:'通知', taskNotice:'タスク完了通知', taskNoticeDesc:'タスク完了時にシステム通知を表示', voiceShortcuts:'音声ショートカット', voiceShortcutEnable:'Alt / Alt+Space の音声ショートカットを有効化', voiceShortcutEnableDesc:'Alt は入力欄に挿入、Alt + Space はタスクを直接送信します。既定ではオフです。', desktopAssistant:'デスクトップアシスタント', pet:'デスクトップコンパニオン', petDesc:'デスクトップに常駐コンパニオンを表示', version:'バージョン', currentVersion:'現在のバージョン', beta:'ベータ版', releaseNotes:'更新内容', noReleaseNotes:'更新内容はありません', downloading:p=>`更新をダウンロード中 ${p}%`, installingUpdate:'更新をインストール中…', installerStarted:'インストーラー起動済み', cancelDownload:'ダウンロードをキャンセル', providers:'プロバイダー' },
        ...
        voiceStructuredMode: 'リストに整理', voiceEditMode: '現在の入力を編集', voiceStructuredPostprocessing: 'リストに整理中…',
        voiceEditPostprocessing: '現在の入力を編集しています…', voiceEditPreviewReady: '音声編集を確認してください', voiceEditApplied: '音声編集を適用しました', voiceEditNoChange: '音声編集で変更はありません',
        voiceModeMenu: '音声モード', voiceContinueDictation: '音声入力を続ける', voiceEditPreviewTitle: '音声編集プレビュー',
        ...
        voiceIntroComboLabel: '組み合わせ',
        voiceIntroModeLabel: 'モード',
        voiceIntroDictationMode: '音声入力',
        voiceIntroDictationTitle: 'Alt を押す',
        voiceIntroDictationDesc: '一度押して録音開始、もう一度押して終了します。認識結果は入力欄に入ります。',
        voiceIntroDictationSteps: ['Alt で録音開始', 'もう一度 Alt で録音終了', 'テキストを入力欄に挿入して編集できます'],
        voiceIntroTaskMode: 'タスク送信',
        voiceIntroTaskTitle: 'Alt + Space を押す',
        voiceIntroTaskDesc: 'Alt + Space でタスク録音を開始し、もう一度押すと Pinvou に直接送信します。',
        voiceIntroTaskSteps: ['Alt + Space で録音開始', 'もう一度 Alt + Space で録音終了', '認識結果を Pinvou に直接送信します'],
        voiceIntroTaskExampleLabel: 'タスク例',
        voiceIntroTaskExample: '「昨日の会議メモを整理し、ToDo を抽出して進捗表を作って。」',
        voiceIntroTaskHint: 'もう一度 Alt + Space で終了して実行',
        voiceIntroGotIt: '今は有効化せず続ける',
        voiceIntroStart: '了解、音声入力を開始',
        voiceIntroEnable: '有効化して続ける',
        voiceShortcutEnableTitle: '音声ショートカットを有効化',
        voiceShortcutEnableDesc: 'Alt は入力欄に挿入、Alt + Space はタスクを直接送信します。',
