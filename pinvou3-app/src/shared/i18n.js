...
const conversationZh = {
  ...
  exportReply:'导出', exportReplyTitle:'导出回复', exportMarkdown:'Markdown 文档', exportMarkdownHint:'默认，保留原始排版', exportHtml:'HTML 文档', exportHtmlHint:'适合在浏览器中查看', exportSuccess:'导出成功', exportFailed:'导出失败',
  shareReply:'分享', shareReplyTitle:'分享回复', shareSystem:'系统分享', shareSystemHint:'选择系统中已安装的通信应用', shareApps:'复制内容并打开应用', shareSuccess:'已分享', shareCopied:'内容已复制', shareCopiedOpen:app=>`内容已复制，已尝试打开${app}，请粘贴发送`, shareCopiedWeb:app=>`内容已复制，请打开${app}粘贴发送`, shareFailed:'分享失败', shareUnavailable:'系统分享不可用，内容已复制', shareTargets:{wechat:'微信',wecom:'企业微信',feishu:'飞书',dingtalk:'钉钉',qq:'QQ'},
};
...
const conversationJa = {
  ...
  exportReply:'エクスポート', exportReplyTitle:'返信をエクスポート', exportMarkdown:'Markdown 文書', exportMarkdownHint:'既定。元の書式を保持', exportHtml:'HTML 文書', exportHtmlHint:'ブラウザーでの閲覧に最適', exportSuccess:'エクスポートしました', exportFailed:'エクスポートに失敗しました',
  shareReply:'共有', shareReplyTitle:'返信を共有', shareSystem:'システム共有', shareSystemHint:'インストール済みの通信アプリを選択', shareApps:'内容をコピーしてアプリを開く', shareSuccess:'共有しました', shareCopied:'内容をコピーしました', shareCopiedOpen:app=>`内容をコピーし、${app}を開きました。貼り付けて送信してください`, shareCopiedWeb:app=>`内容をコピーしました。${app}を開いて貼り付けてください`, shareFailed:'共有に失敗しました', shareUnavailable:'システム共有を利用できないため、内容をコピーしました', shareTargets:{wechat:'WeChat',wecom:'WeCom',feishu:'Feishu',dingtalk:'DingTalk',qq:'QQ'},
};
