...
const codexZh = {
  ...
  applyingConfig:'配置应用中…', workspace:'工作区', workspaceTitle:'查看 Codex 工作区文件和更改',
  recreatePrefix:'原项目目录已不存在，', recreate:'重新创建会话',
  welcomeTitle:'用 Codex 处理代码任务',
  ...
  model:'模型', permissionMode:'权限模式', sessionModeTitle:'Codex Agent 上报的会话模式',
  configLabels:{ mode:'权限模式', collaboration_mode:'协作方式', model:'模型', reasoning_effort:'推理强度', 'fast-mode':'快速模式' },
  commandMenuClose:'关闭 Codex 命令菜单', agentCommands:'Codex Agent 命令',
  placeholder:'让 Codex 处理代码、运行命令或解释仓库…', temporarySession:'临时会话',
  workspaceMenuClose:'关闭工作目录菜单', chooseProject:'选择项目目录', chooseProjectDesc:'Codex 直接在真实项目中工作',
  temporarySessionDesc:'使用 Pinvou 管理的隔离目录', recentProjects:'最近项目',
  addAttachment:'添加附件', commandsAvailable:'Codex Agent 上报的命令', commandsAfterSession:'创建会话后同步 Codex 命令',
...
const codexEn = {
  ...
  applyingConfig:'Applying configuration…', workspace:'Workspace', workspaceTitle:'View Codex workspace files and changes',
  recreatePrefix:'The original project directory no longer exists. ', recreate:'Recreate session',
  welcomeTitle:'Use Codex for coding tasks',
  ...
  model:'Model', permissionMode:'Permission mode', sessionModeTitle:'Session mode reported by Codex Agent',
  ...
  commandMenuClose:'Close Codex command menu', agentCommands:'Codex Agent commands',
  placeholder:'Ask Codex to edit code, run commands, or explain the repository…', temporarySession:'Temporary session',
  workspaceMenuClose:'Close working-directory menu', chooseProject:'Choose project directory', chooseProjectDesc:'Let Codex work directly in a real project',
  temporarySessionDesc:'Use an isolated directory managed by Pinvou', recentProjects:'Recent projects',
  addAttachment:'Add attachment', commandsAvailable:'Commands reported by Codex Agent', commandsAfterSession:'Codex commands sync after a session is created',
...
const codexJa = {
  ...
  applyingConfig:'設定を適用中…', workspace:'ワークスペース', workspaceTitle:'Codex ワークスペースのファイルと変更を表示',
  recreatePrefix:'元のプロジェクトディレクトリが存在しません。', recreate:'セッションを再作成',
  welcomeTitle:'Codex でコーディングタスクを処理',
  ...
  model:'モデル', permissionMode:'権限モード', sessionModeTitle:'Codex Agent が報告したセッションモード',
  configLabels:{ mode:'権限モード', collaboration_mode:'共同作業モード', model:'モデル', reasoning_effort:'推論強度', 'fast-mode':'高速モード' },
  commandMenuClose:'Codex コマンドメニューを閉じる', agentCommands:'Codex Agent コマンド',
  placeholder:'Codex にコード編集、コマンド実行、リポジトリ説明を依頼…', temporarySession:'一時セッション',
  workspaceMenuClose:'作業ディレクトリメニューを閉じる', chooseProject:'プロジェクトディレクトリを選択', chooseProjectDesc:'Codex が実際のプロジェクトで直接作業します',
  temporarySessionDesc:'Pinvou が管理する隔離ディレクトリを使用', recentProjects:'最近のプロジェクト',
  addAttachment:'添付ファイルを追加', commandsAvailable:'Codex Agent が報告したコマンド', commandsAfterSession:'セッション作成後に Codex コマンドを同期',
