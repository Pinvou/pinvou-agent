...
const dict = {
      zh: {
        ...
        shellCleanupFailed: '部分后台任务未能停止，可在后台任务列表中逐个停止。',
      ...
      en: {
        ...
        shellCleanupFailed: 'Some background tasks could not be stopped. You can stop them individually from the background task list.',
      ...
      ja: {
        ...
        shellCleanupFailed: '一部のバックグラウンドタスクを停止できませんでした。バックグラウンドタスク一覧から個別に停止できます。',
