...
const codexZh = {
  ...
  nativeMemory:'记忆', nativeMemoryTitle:'本会话生效的记忆', nativeMemoryClose:'关闭记忆面板',
...
const codexEn = {
  ...
  nativeMemory:'Memory', nativeMemoryTitle:'Memories active in this session', nativeMemoryClose:'Close memory panel',
...
const codexJa = {
  ...
  nativeMemory:'メモリ', nativeMemoryTitle:'このセッションで有効なメモリ', nativeMemoryClose:'メモリパネルを閉じる',
...
dict.zh.uiAios = {
  ...
  goodEvening: '晚上好',
  emptyTitle: '准备好开始了吗',
  emptyDesc: '请在下方通过语音或打字开始新会话。我可以帮您安排任务、头脑风暴或起草文档。',
  globalInputPlaceholder: '开启新会话...',
  sessionInputPlaceholder: '继续对话...',
  listening: '聆听中...',
  startVoice: '开始语音输入',
  ...
  ctripStatus: {
    ...
    wendaoReady: '已返回结果',
    browserPrepare: '准备打开',
    browserSearching: '网页协助',
    browserOrderReview: '订单核对',
    submitConfirmationRequired: '提交确认',
    paymentRequired: '待支付',
    userActionRequired: '需要接管',
    browserBlocked: '协助受阻',
    browserCancelled: '已结束',
    handoffDone: '已接管',
    needsChoice: '需要选择',
    validating: '处理中',
    orderConfirm: '待确认',
  ...
  ctrip: {
    kicker: '携程问道连接器',
    title: '携程问道查询',
    checkingAuth: '正在检查携程问道 Token',
    checkingAuthDesc: '我会先确认 WorkBuddy 的携程问道连接器能否查询。',
    needAuth: '需要配置携程问道 Token',
    needAuthDesc: '我不会要求你的携程账号密码。这里使用携程问道开放平台 API Token，只用于查询旅行信息。',
    capabilityBlocked: '连接器能力不足',
    capabilityBlockedDesc: '当前连接器不可用，只能手动打开携程。',
    capabilityMatrix: '能力矩阵',
    apiToken: 'API Token',
    apiTokenPlaceholder: '粘贴携程问道开放平台 Token',
    applyToken: '去携程问道开放平台申请 Token',
    skipAuth: '先不配置',
    connect: '保存 Token',
    disconnect: '清除 Token',
    detailsTitle: '补全行程信息',
    detailsDesc: '为了避免连续追问，请一次性确认出发地、目的地、日期和偏好。',
    origin: '出发地',
    destination: '目的地',
    date: '日期',
    passenger: '乘机人',
    ...
    search: '调用携程问道',
    searching: '正在调用携程问道',
    searchingDesc: '我会只展示携程问道返回的 result，不暴露内部日志。',
    resultTitle: '携程问道结果',
    resultDesc: '下面是查询结果。下单、登录和支付需要前往携程官方页面完成。',
    orderBoundary: '下单边界',
    orderBoundaryDesc: 'Pinvou 负责查询与整理，最终下单和支付在携程完成',
    openCtrip: '去携程继续办理',
    browserPrepare: '正在打开携程专用协助窗口',
    browserPrepareDesc: '我会在 Pinvou 的携程窗口里尝试填写查询条件。登录、验证码、实名信息、提交订单和支付会由你亲自处理。',
    browserSearchingTitle: '已在携程窗口尝试搜索',
    browserSearchingDesc: '我已打开携程专用窗口，并尝试填写出发地、目的地、日期和人数后触发搜索。页面结果、登录、验证码、实名信息和最终提交仍需要你在携程窗口确认。',
    autoSearchCard: '自动搜索记录',
    autoFilled: '已尝试填写',
    autoFilledUnknown: '页面可识别项',
    autoClickedSearch: '触发搜索',
    autoBoundary: '自动化边界',
    autoBoundaryDesc: 'Pinvou 只尝试搜索条件，不处理登录、验证码、实名信息、提交订单或支付',
    retryAutoSearch: '重新尝试搜索',
    resultReady: '我看到结果了',
    userActionRequired: '需要你在携程接管',
    userActionRequiredDesc: '携程页面已打开。涉及登录、验证码、乘机人实名信息、提交订单和支付时，需要你亲自确认。',
    browserBlocked: '浏览器协助受阻',
    browserBlockedDesc: '携程页面可能出现风控、验证码、网络异常或页面结构变化。我已保留查询条件，方便你手动继续。',
    handoffCard: '接管信息',
    ctripLink: '携程链接',
    manualBoundary: '协助边界',
    manualBoundaryDesc: 'Pinvou 不输入账号密码、不绕过验证码；最终提交前必须确认，支付由你完成',
    endAssist: '结束协助',
    continueAssist: '我已完成，继续协助',
    reopenCtrip: '重新打开携程',
    orderReviewTitle: '核对携程订单页',
    orderReviewDesc: '请以携程页面为准核对航班/酒店、乘机人数量、总价和退改规则。当前版本尚未接入网页 DOM 自动读取。',
    reviewBoundary: '核对边界',
    reviewBoundaryDesc: '价格、库存、退改规则以携程页面实时显示为准；有变化必须重新确认',
    goSubmitConfirm: '进入提交确认',
    submitConfirmTitle: '最终提交前确认',
    submitConfirmDesc: '请再次核对携程页面显示的总价、乘机人数量和退改规则。当前版本不能自动点击提交，确认后会回到携程页面由你手动提交。',
    paymentBoundary: '支付边界',
    paymentBoundaryDesc: '进入支付渠道、选择支付方式、付款确认和支付验证码全部由你本人完成',
    submitChecklist: '提交前检查',
    checkRoute: '航班/酒店',
    checkRouteDesc: '以携程页面当前展示为准',
    checkPrice: '总价',
    checkPriceDesc: '确认没有价格或库存变化',
    checkPeople: '乘机人/入住人',
    checkPeopleDesc: '只核对数量，不在 Pinvou 展示完整证件号',
    checkRules: '退改规则',
    checkRulesDesc: '确认退改签/取消规则可以接受',
    backToReview: '返回核对',
    manualSubmit: '我已确认，去携程手动提交',
    paymentRequiredTitle: '支付由你完成',
    paymentRequiredDesc: '如果你已在携程提交订单，请在携程页面完成支付。Pinvou 不点击支付入口、不选择支付方式、不读取或提交支付验证码。',
    offersTitle: '查询结果',
    offersDesc: '下单需要前往携程官方页面完成。',
    validating: '正在处理',
    validatingDesc: '正在处理携程问道结果。',
    submittingOrder: '正在处理',
    submittingOrderDesc: '正在处理。',
    confirmTitle: '确认',
    confirmDesc: '请确认后前往携程完成。',
    flight: '航班',
    route: '行程',
    depart: '出发',
    refundRule: '退改签',
    ...
    submitOrder: '去携程完成',
    orderCreated: '已完成',
    orderCreatedDesc: '结果已生成。最终下单和支付仍在携程完成。',
    orderId: '编号',
  },
  ...
  noArtifact: '尚未生成产物。',
  copyArtifact: '复制产物',
  artifactItem: index => `产物 ${index}`,
  quickActions: {
    schedule: { label: '规划日程', prompt: '规划本周日程并排定优先级' },
    mail: { label: '起草邮件', prompt: '起草一封给设计团队的邮件' },
    brainstorm: { label: '头脑风暴 UI', prompt: '为 iOS 应用头脑风暴 UI 创意' },
  },
};
dict.en.uiAios = {
  ...
  emptyDesc: 'Start a new session below with voice or text. I can help plan tasks, brainstorm, or draft documents.',
  globalInputPlaceholder: 'Start a new session...',
  sessionInputPlaceholder: 'Continue the conversation...',
  listening: 'Listening...',
  startVoice: 'Start voice input',
  stopListening: 'Stop voice input',
  send: 'Send',
  toggleTheme: 'Toggle theme',
  taskGrid: 'AIOS session desktop',
  untitledTask: 'New session',
  recently: 'Just now',
  processing: 'Processing',
  choiceNeeded: 'Input needed',
  resultReady: 'Result ready',
  artifactReady: 'Artifact ready',
  taskFailed: 'Failed',
  ctripStatus: {
    authChecking: 'Checking auth',
    needsAuth: 'Token needed',
    authorizing: 'Configuring',
    authFailed: 'Config failed',
    needsDetails: 'Input needed',
    searching: 'Searching',
    wendaoReady: 'Result ready',
    browserPrepare: 'Opening',
    browserSearching: 'Browser assist',
    browserOrderReview: 'Order review',
    submitConfirmationRequired: 'Submit confirm',
    paymentRequired: 'Payment needed',
    userActionRequired: 'Take over',
    browserBlocked: 'Blocked',
    browserCancelled: 'Ended',
    handoffDone: 'Handed off',
    needsChoice: 'Choice needed',
  ...
  ctrip: {
    kicker: 'Ctrip Wendao connector',
    title: 'Ctrip Wendao search',
    checkingAuth: 'Checking Ctrip Wendao token',
    checkingAuthDesc: 'I will verify the WorkBuddy Ctrip Wendao connector before querying.',
    needAuth: 'Configure Ctrip Wendao token',
    needAuthDesc: 'Do not send your Ctrip password. This uses a Ctrip Wendao Open Platform API token for travel queries only.',
    capabilityBlocked: 'Connector capability missing',
    capabilityBlockedDesc: 'This connector is unavailable. Open Ctrip manually to continue.',
    capabilityMatrix: 'Capability matrix',
    apiToken: 'API Token',
    apiTokenPlaceholder: 'Paste Ctrip Wendao Open Platform token',
    applyToken: 'Apply for a Ctrip Wendao token',
    skipAuth: 'Not now',
    connect: 'Save token',
    disconnect: 'Clear token',
    detailsTitle: 'Complete trip details',
    detailsDesc: 'Confirm origin, destination, date, and preferences in one form.',
    origin: 'Origin',
    ...
    search: 'Query Wendao',
    searching: 'Calling Ctrip Wendao',
    searchingDesc: 'Only the result field will be displayed; internal logs are hidden.',
    resultTitle: 'Ctrip Wendao result',
    resultDesc: 'Review the result below. Login, ordering, and payment must happen on Ctrip.',
    orderBoundary: 'Ordering boundary',
    orderBoundaryDesc: 'Pinvou handles search and organization; final ordering and payment happen on Ctrip',
    openCtrip: 'Continue on Ctrip',
    browserPrepare: 'Opening Ctrip assist window',
    browserPrepareDesc: 'I will try to fill search details inside Pinvou’s Ctrip window. Login, captcha, identity info, order submission, and payment stay under your control.',
    browserSearchingTitle: 'Search attempted in Ctrip',
    browserSearchingDesc: 'I opened the Ctrip assist window and tried to fill origin, destination, date, and passenger count before triggering search. Results, login, captcha, identity info, and final submission still need your confirmation in Ctrip.',
    autoSearchCard: 'Auto-search log',
    autoFilled: 'Attempted fields',
    autoFilledUnknown: 'Recognized fields',
    autoClickedSearch: 'Triggered search',
    autoBoundary: 'Automation boundary',
    autoBoundaryDesc: 'Pinvou only attempts search fields; it does not handle login, captcha, identity info, order submission, or payment',
    retryAutoSearch: 'Retry search',
    resultReady: 'I see results',
    userActionRequired: 'Take over on Ctrip',
    userActionRequiredDesc: 'Ctrip is open. Please handle login, captcha, passenger identity, order submission, and payment yourself.',
    browserBlocked: 'Browser assistance blocked',
    browserBlockedDesc: 'Ctrip may have shown risk control, captcha, network failure, or page changes. I kept the query details for manual continuation.',
    handoffCard: 'Handoff details',
    ctripLink: 'Ctrip link',
    manualBoundary: 'Assist boundary',
    manualBoundaryDesc: 'Pinvou does not enter passwords or bypass captcha; final submission needs confirmation, and payment is yours',
    endAssist: 'End assist',
    continueAssist: 'I am done, continue',
    reopenCtrip: 'Reopen Ctrip',
    orderReviewTitle: 'Review the Ctrip order page',
    orderReviewDesc: 'Please verify flight/hotel details, passenger count, total price, and rules on Ctrip. This version does not read page DOM automatically yet.',
    reviewBoundary: 'Review boundary',
    reviewBoundaryDesc: 'Price, inventory, and rules must follow the live Ctrip page; any change needs reconfirmation',
    goSubmitConfirm: 'Continue to submit confirmation',
    submitConfirmTitle: 'Confirm before final submission',
    submitConfirmDesc: 'Check the total price, passenger count, and rules on Ctrip again. This version cannot click submit automatically; after confirming, you will submit manually on Ctrip.',
    paymentBoundary: 'Payment boundary',
    paymentBoundaryDesc: 'Entering payment channels, choosing payment methods, confirming payment, and payment codes are handled by you',
    submitChecklist: 'Pre-submit checklist',
    checkRoute: 'Flight/hotel',
    checkRouteDesc: 'Use the current Ctrip page as source of truth',
    checkPrice: 'Total price',
    checkPriceDesc: 'Confirm no price or inventory change',
    checkPeople: 'Passengers/guests',
    checkPeopleDesc: 'Only verify count; Pinvou does not show full identity numbers',
    checkRules: 'Rules',
    checkRulesDesc: 'Confirm refund/change/cancel rules are acceptable',
    backToReview: 'Back to review',
    manualSubmit: 'Confirmed, submit manually on Ctrip',
    paymentRequiredTitle: 'Payment is yours',
    paymentRequiredDesc: 'If you submitted the order on Ctrip, please pay on Ctrip. Pinvou will not click payment, choose a payment method, or read/submit payment codes.',
    offersTitle: 'Search result',
    offersDesc: 'Continue on Ctrip.',
    validating: 'Processing',
    validatingDesc: 'Processing Ctrip Wendao result.',
    submittingOrder: 'Processing',
    submittingOrderDesc: 'Processing.',
    confirmTitle: 'Confirm',
    confirmDesc: 'Confirm before opening Ctrip.',
    flight: 'Flight',
    route: 'Route',
    depart: 'Depart',
    refundRule: 'Rules',
    finalPrice: 'Final price',
    submitOrder: 'Open Ctrip',
    orderCreated: 'Done',
    orderCreatedDesc: 'Result generated. Final ordering and payment still happen on Ctrip.',
    orderId: 'ID',
  },
  ...
  dialogue: 'Dialogue',
  artifact: 'Artifact',
  noDialogue: 'No dialogue yet.',
  noArtifact: 'No artifact generated yet.',
  copyArtifact: 'Copy artifact',
  artifactItem: index => `Artifact ${index}`,
  quickActions: {
    schedule: { label: 'Plan schedule', prompt: 'Plan this week and prioritize the agenda' },
    mail: { label: 'Draft email', prompt: 'Draft an email to the design team' },
    brainstorm: { label: 'Brainstorm UI', prompt: 'Brainstorm UI ideas for an iOS app' },
  },
};
dict.ja.uiAios = {
  ...
  goodAfternoon: 'こんにちは',
  goodEvening: 'こんばんは',
  emptyTitle: '始める準備はできていますか',
  emptyDesc: '下の音声またはテキスト入力から新しいセッションを開始できます。タスク整理、ブレインストーミング、文書作成を支援します。',
  globalInputPlaceholder: '新しいセッションを開始...',
  sessionInputPlaceholder: '会話を続ける...',
  listening: '聞き取り中...',
  startVoice: '音声入力を開始',
  stopListening: '音声入力を停止',
  send: '送信',
  toggleTheme: 'テーマを切り替え',
  taskGrid: 'AIOS セッションデスクトップ',
  untitledTask: '新しいセッション',
  recently: 'たった今',
  processing: '処理中',
  choiceNeeded: '選択が必要',
  resultReady: '結果が生成されました',
  artifactReady: '成果物が生成されました',
  taskFailed: '失敗',
  ctripStatus: {
    authChecking: '認証確認中',
    needsAuth: 'Token が必要',
    ...
    wendaoReady: '結果あり',
    browserPrepare: '準備中',
    browserSearching: 'ブラウザ支援',
    browserOrderReview: '注文確認',
    submitConfirmationRequired: '送信確認',
    paymentRequired: '支払い待ち',
    userActionRequired: '操作が必要',
    browserBlocked: '支援停止',
    browserCancelled: '終了',
    handoffDone: '引き継ぎ済み',
    needsChoice: '選択が必要',
  ...
  ctrip: {
    kicker: 'Ctrip Wendao コネクタ',
    title: 'Ctrip Wendao 検索',
    checkingAuth: 'Ctrip Wendao Token を確認中',
    checkingAuthDesc: 'WorkBuddy の Ctrip Wendao コネクタを確認してから検索します。',
    needAuth: 'Ctrip Wendao Token を設定',
    needAuthDesc: 'Ctrip のパスワードは入力しないでください。旅行検索用の Ctrip Wendao Open Platform API Token だけを使います。',
    capabilityBlocked: 'コネクタ機能不足',
    capabilityBlockedDesc: '現在のコネクタは利用できません。Ctrip を手動で開いてください。',
    capabilityMatrix: '機能マトリクス',
    apiToken: 'API Token',
    apiTokenPlaceholder: 'Ctrip Wendao Open Platform Token を貼り付け',
    applyToken: 'Ctrip Wendao Token を申請',
    skipAuth: '今は設定しない',
    connect: 'Token を保存',
    disconnect: 'Token を削除',
    detailsTitle: '旅程情報を補完',
    detailsDesc: '出発地、目的地、日付、希望条件をまとめて確認します。',
    origin: '出発地',
    destination: '目的地',
    date: '日付',
    passenger: '搭乗者',
    ...
    budget: '予算',
    timePreference: '時間希望',
    search: 'Wendao に問い合わせ',
    searching: 'Ctrip Wendao を呼び出し中',
    searchingDesc: 'result フィールドのみ表示し、内部ログは表示しません。',
    resultTitle: 'Ctrip Wendao 結果',
    resultDesc: '下記の結果を確認してください。ログイン、注文、支払いは Ctrip 公式ページで行います。',
    orderBoundary: '注文の境界',
    orderBoundaryDesc: 'Pinvou は検索と整理を行い、最終注文と支払いは Ctrip で行います',
    openCtrip: 'Ctrip で続行',
    browserPrepare: 'Ctrip 支援ウィンドウを開いています',
    browserPrepareDesc: 'Pinvou の Ctrip ウィンドウで検索条件の入力を試みます。ログイン、認証、本人情報、注文送信、支払いはユーザーが行います。',
    browserSearchingTitle: 'Ctrip で検索を試行しました',
    browserSearchingDesc: 'Ctrip 支援ウィンドウを開き、出発地、目的地、日付、人数を入力して検索を試みました。結果、ログイン、認証、本人情報、最終送信は Ctrip 側で確認してください。',
    autoSearchCard: '自動検索ログ',
    autoFilled: '入力を試みた項目',
    autoFilledUnknown: '認識済み項目',
    autoClickedSearch: '検索実行',
    autoBoundary: '自動化範囲',
    autoBoundaryDesc: 'Pinvou は検索条件のみ試行し、ログイン、認証、本人情報、注文送信、支払いは処理しません',
    retryAutoSearch: '検索を再試行',
    resultReady: '結果を確認した',
    userActionRequired: 'Ctrip で操作してください',
    userActionRequiredDesc: 'Ctrip ページを開きました。ログイン、認証、搭乗者情報、注文送信、支払いはユーザーが確認してください。',
    browserBlocked: 'ブラウザ支援が停止しました',
    browserBlockedDesc: 'Ctrip のリスク制御、認証、ネットワーク異常、ページ変更の可能性があります。手動継続用に検索条件を保持しました。',
    handoffCard: '引き継ぎ情報',
    ctripLink: 'Ctrip リンク',
    manualBoundary: '支援範囲',
    manualBoundaryDesc: 'Pinvou はパスワード入力や認証回避を行いません。最終送信は確認が必要で、支払いはユーザーが行います',
    endAssist: '支援を終了',
    continueAssist: '完了、続行',
    reopenCtrip: 'Ctrip を再度開く',
    orderReviewTitle: 'Ctrip 注文ページを確認',
    orderReviewDesc: 'Ctrip ページ上で便/ホテル、人数、合計金額、規則を確認してください。現版はページ DOM の自動読み取り未対応です。',
    reviewBoundary: '確認範囲',
    reviewBoundaryDesc: '価格、在庫、規則は Ctrip ページのリアルタイム表示を優先し、変更があれば再確認します',
    goSubmitConfirm: '送信確認へ',
    submitConfirmTitle: '最終送信前の確認',
    submitConfirmDesc: 'Ctrip ページの合計金額、人数、規則を再確認してください。現版は自動送信できないため、確認後 Ctrip で手動送信します。',
    paymentBoundary: '支払い範囲',
    paymentBoundaryDesc: '支払いチャネル、支払い方法、支払い確認、認証コードはすべてユーザーが操作します',
    submitChecklist: '送信前チェック',
    checkRoute: '便/ホテル',
    checkRouteDesc: 'Ctrip ページの現在表示を基準にしてください',
    checkPrice: '合計金額',
    checkPriceDesc: '価格や在庫変更がないことを確認',
    checkPeople: '搭乗者/宿泊者',
    checkPeopleDesc: '人数のみ確認し、完全な証明書番号は表示しません',
    checkRules: '規則',
    checkRulesDesc: '変更/払い戻し/キャンセル規則を確認',
    backToReview: '確認へ戻る',
    manualSubmit: '確認済み、Ctrip で手動送信',
    paymentRequiredTitle: '支払いはユーザーが実行',
    paymentRequiredDesc: 'Ctrip で注文を送信した場合、Ctrip で支払ってください。Pinvou は支払い入口、方法選択、認証コードの読み取り/送信を行いません。',
    offersTitle: '検索結果',
    offersDesc: 'Ctrip で続行してください。',
    validating: '処理中',
    validatingDesc: 'Ctrip Wendao の結果を処理しています。',
    submittingOrder: '処理中',
    submittingOrderDesc: '処理しています。',
    confirmTitle: '確認',
    confirmDesc: '確認してから Ctrip を開きます。',
    flight: '便',
    route: '行程',
    depart: '出発',
    refundRule: '規則',
    finalPrice: '最終価格',
    submitOrder: 'Ctrip を開く',
    orderCreated: '完了',
    orderCreatedDesc: '結果を生成しました。最終注文と支払いは Ctrip で行います。',
    orderId: 'ID',
  },
  openTask: title => `${title} を開く`,
  closeTask: 'タスクを閉じる',
  dialogue: '対話',
  artifact: '成果物',
  noDialogue: '対話履歴はまだありません。',
  noArtifact: '成果物はまだ生成されていません。',
  copyArtifact: '成果物をコピー',
  artifactItem: index => `成果物 ${index}`,
  quickActions: {
    schedule: { label: '予定を整理', prompt: '今週の予定を整理し、優先順位を付けてください' },
    mail: { label: 'メール作成', prompt: 'デザインチーム宛てのメールを作成してください' },
    brainstorm: { label: 'UI 発想', prompt: 'iOS アプリの UI アイデアをブレインストーミングしてください' },
  },
};
