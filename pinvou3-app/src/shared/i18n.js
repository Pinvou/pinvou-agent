...
const dict = {
      zh: {
        ...
        artifactPreview: { browserTitle:'交付物浏览器', localArtifact:'本地交付物', close:'关闭交付物浏览器', escapeHint:'Esc 关闭', safePreview:'安全预览', download:'下载', openExternal:'用系统应用打开', loading:'正在准备预览…', fileMissing:'文件不存在或已被删除', tooLarge:'文件过大，未载入内置预览', readFailed:e=>`读取失败: ${e}`, imageReadFailed:e=>`图片读取失败: ${e}`, previewUnsupported:'此类型暂不支持内置预览', downloadArtifact:'下载交付物', openExternalArtifact:'用系统应用打开', externalLinkTitle:'打开外部链接？', externalLinkPrompt:host=>`交付物请求打开 ${host}。确认后将交给系统浏览器。`, cancel:'取消', openLink:'继续打开' },
        ...
        queuedTag: '排队中', queuedCancel: '撤销', queuedPriorityDegraded: '这条远程消息已保留，但暂时无法保证它优先于后台结果。',
        ...
        voiceRequesting: '正在请求麦克风权限…', voiceRequestingCancelable: '正在请求麦克风权限，再点一次取消', voiceRecording: '正在录音，再点一次结束', voiceTranscribing: '正在识别语音…', voiceTranscribingCancelable: '正在识别语音，再点一次取消',
        voiceQueuedRegion: '待处理的插话', voiceQueuedStatus: '已排队', voiceQueuedCancel: text => `撤销排队消息：${text}`,
        voiceTurnFeedbackReady: '已处理 3 秒以上。你可以继续说，消息会依次排队。', voiceTurnFeedbackLong: '已处理 15 秒以上，复杂步骤可能需要一点时间。你可以继续说，消息会依次排队。', voiceTurnFeedbackExtended: '已处理 30 秒以上，我仍在处理。你可以继续说，新消息会按顺序排队。',
      ...
      en: {
        ...
        artifactPreview: { browserTitle:'Artifact Browser', localArtifact:'Local artifact', close:'Close artifact browser', escapeHint:'Esc to close', safePreview:'Safe preview', download:'Download', openExternal:'Open with system app', loading:'Preparing preview…', fileMissing:'File does not exist or has been deleted', tooLarge:'This file is too large for an embedded preview', readFailed:e=>`Read failed: ${e}`, imageReadFailed:e=>`Image read failed: ${e}`, previewUnsupported:'Built-in preview is not supported for this type', downloadArtifact:'Download artifact', openExternalArtifact:'Open with system app', externalLinkTitle:'Open external link?', externalLinkPrompt:host=>`This artifact is asking to open ${host}. It will be handed to your system browser after confirmation.`, cancel:'Cancel', openLink:'Continue' },
        ...
        queuedTag: 'Queued', queuedCancel: 'Remove', queuedPriorityDegraded: 'This remote message was kept, but it may not precede a background result.',
        ...
        voiceRequesting: 'Requesting microphone permission…', voiceRequestingCancelable: 'Requesting microphone permission; click again to cancel', voiceRecording: 'Recording, click again to stop', voiceTranscribing: 'Transcribing voice…', voiceTranscribingCancelable: 'Transcribing voice; click again to cancel',
        voiceQueuedRegion: 'Queued interjections', voiceQueuedStatus: 'Queued', voiceQueuedCancel: text => `Remove queued message: ${text}`,
        voiceTurnFeedbackReady: 'Processing for over 3 seconds. You can keep talking; new messages will queue in order.', voiceTurnFeedbackLong: 'Processing for over 15 seconds. Complex steps can take a little time; you can keep talking and messages will queue in order.', voiceTurnFeedbackExtended: 'Processing for over 30 seconds. I am still working; you can keep talking and new messages will queue in order.',
      ...
      ja: {
        ...
        artifactPreview: { browserTitle:'成果物ブラウザー', localArtifact:'ローカル成果物', close:'成果物ブラウザーを閉じる', escapeHint:'Esc で閉じる', safePreview:'安全プレビュー', download:'ダウンロード', openExternal:'システムアプリで開く', loading:'プレビューを準備中…', fileMissing:'ファイルが存在しないか削除されました', tooLarge:'ファイルが大きすぎるため内蔵プレビューを読み込みません', readFailed:e=>`読み取りに失敗: ${e}`, imageReadFailed:e=>`画像の読み取りに失敗: ${e}`, previewUnsupported:'このタイプは内蔵プレビューに対応していません', downloadArtifact:'成果物をダウンロード', openExternalArtifact:'システムアプリで開く', externalLinkTitle:'外部リンクを開きますか？', externalLinkPrompt:host=>`成果物が ${host} を開こうとしています。確認後、システムブラウザーに引き渡します。`, cancel:'キャンセル', openLink:'開く' },
        ...
        queuedTag: '待機中', queuedCancel: '取り消し', queuedPriorityDegraded: 'このリモートメッセージは保持されましたが、バックグラウンド結果より先に処理される保証はありません。',
        ...
        voiceRequesting: 'マイク権限を確認中…', voiceRequestingCancelable: 'マイク権限を確認中。もう一度押すとキャンセル', voiceRecording: '録音中。もう一度押すと終了', voiceTranscribing: '音声を認識中…', voiceTranscribingCancelable: '音声を認識中。もう一度押すとキャンセル',
        voiceQueuedRegion: '処理待ちの割り込み', voiceQueuedStatus: '待機中', voiceQueuedCancel: text => `待機中のメッセージを取り消す：${text}`,
        voiceTurnFeedbackReady: '処理開始から3秒以上経過しました。そのまま話せます。新しいメッセージは順番に待機します。', voiceTurnFeedbackLong: '処理開始から15秒以上経過しました。複雑な処理には少し時間がかかることがあります。そのまま話せます。メッセージは順番に待機します。', voiceTurnFeedbackExtended: '処理開始から30秒以上経過しました。引き続き処理中です。そのまま話せます。新しいメッセージは順番に待機します。',
...
// PinvouOS 连续身份与常驻 Agent Runtime。旧执行底座标识不得进入这组界面文案。
Object.assign(dict.zh, { uiPinvouOs: {
  identity:'Pinvou', continuous:'持续在线', oneIdentity:'一个交互界面 · 一个连续身份',
  canvasTitle:'交互画布', canvasRuntimeSummary:'画布运行状态', activeMissions:'进行中的目标',
  interactionStates:{ idle:'等你开口', submitted:'已收到', running:'正在处理', interrupted:'等你确认', completed:'已完成', cancelled:'已取消', failed:'未完成' },
  agentsLabel:'Agent', running:'运行中', pressure:'资源压力',
  pressures:{ normal:'正常', warm:'偏高', hot:'过热', critical:'危险' },
  cpu:'CPU', memory:'内存', temperature:'温度', agentRuntime:'Agent Runtime',
  network:'网络', model:'模型', online:'在线', offline:'离线', degraded:'异常', unavailable:'不可用', unknown:'未知',
  modelReady:'就绪', modelUnknown:'未配置', lastCheck:'最近检查', lastSuccess:'最近成功',
  awaitingFirstSuccess:'等待首次成功', failureReason:'故障原因', none:'无',
  runtimeHint:'常驻系统 Agent 与原子能力', refresh:'刷新运行时',
  bridgeUnavailable:'PinvouOS 运行时仅在桌面应用中可用', readFailed:'读取 PinvouOS 运行时失败',
  eventFabric:'事件网络', sharedTruth:'共享事实账本',
  influenceChain:'真实影响链：资源观察 → Claim → Governor → Agent 控制指令',
  openRuntime:'打开 Agent Runtime', closeRuntime:'收起 Agent Runtime',
  ready:'已运行', paused:'已暂停', stopped:'已停止', scaffold:'骨架',
  agents:{
    ...
    'agent:device':{ name:'设备 Agent', role:'维护设备与外设能力事实' },
    'agent:capability':{ name:'能力 Agent', role:'回答 Pinvou 能做、暂时不能做与不支持什么' },
    'agent:memory':{ name:'记忆 Agent', role:'维护连续身份的长期与工作记忆' },
    'agent:policy':{ name:'策略 Agent', role:'把权限、安全与用户边界变成约束' },
    'agent:attention':{ name:'注意力 Agent', role:'在并发目标之间分配优先级与打断预算' },
    'agent:asr-context':{ name:'ASR Context Agent', role:'定期整理语音识别所需的人名与专业术语' },
  },
  reasons:{
    model_route_missing:'模型路由缺失', model_endpoint_missing:'模型地址缺失', model_endpoint_invalid:'模型地址无效',
    probe_unavailable:'网络探针不可用', network_timeout:'连接超时', network_connect_failed:'无法建立连接',
    network_request_failed:'网络请求失败', model_probe_unavailable:'模型探针不可用', missing_api_key:'缺少模型密钥',
    auth_failed:'模型鉴权失败', mismatch:'模型配置不匹配', offline:'模型服务离线', unverified:'模型尚未验证',
  },
  events:{
    runtime_started:'运行时启动', identity_declared:'连续身份就绪', agent_registered:'Agent 注册',
    mission_opened:'目标建立', run_started:'运行开始', resource_observed:'资源观察',
    claim_asserted:'新事实形成', claim_retracted:'事实撤回', directive_issued:'控制指令下发',
    directive_acknowledged:'控制指令确认',
    connectivity_observed:'网络状态更新', inference_health_observed:'模型健康更新', inference_completed:'推理成功',
    interaction_run_opened:'交互已收到', interaction_run_started:'交互开始', interaction_tool_started:'能力调用开始',
    interaction_tool_finished:'能力调用结束', interaction_assistant_message_completed:'回复已形成', interaction_run_finished:'交互结束',
  },
} });
Object.assign(dict.en, { uiPinvouOs: {
  identity:'Pinvou', continuous:'Always on', oneIdentity:'One interface · one continuous identity',
  canvasTitle:'Interaction canvas', canvasRuntimeSummary:'Canvas runtime status', activeMissions:'Active goals',
  interactionStates:{ idle:'Ready when you are', submitted:'Received', running:'Working', interrupted:'Waiting for you', completed:'Complete', cancelled:'Cancelled', failed:'Not completed' },
  agentsLabel:'Agents', running:'Running', pressure:'Pressure',
  pressures:{ normal:'Normal', warm:'Warm', hot:'Hot', critical:'Critical' },
  cpu:'CPU', memory:'Memory', temperature:'Temp', agentRuntime:'Agent Runtime',
  network:'Network', model:'Model', online:'Online', offline:'Offline', degraded:'Degraded', unavailable:'Unavailable', unknown:'Unknown',
  modelReady:'Ready', modelUnknown:'Not configured', lastCheck:'Last check', lastSuccess:'Last success',
  awaitingFirstSuccess:'Awaiting first success', failureReason:'Failure', none:'None',
  runtimeHint:'Resident system agents and atomic capabilities', refresh:'Refresh runtime',
  bridgeUnavailable:'PinvouOS Runtime is available in the desktop app', readFailed:'Failed to read PinvouOS Runtime',
  eventFabric:'Event fabric', sharedTruth:'Shared truth ledger',
  influenceChain:'Live influence chain: resource observation → claim → governor → agent directive',
  openRuntime:'Open Agent Runtime', closeRuntime:'Collapse Agent Runtime',
  ready:'Ready', paused:'Paused', stopped:'Stopped', scaffold:'Scaffold',
  agents:{
    ...
    'agent:device':{ name:'Device Agent', role:'Maintains device and peripheral facts' },
    'agent:capability':{ name:'Capability Agent', role:'Explains what Pinvou can, cannot yet, and cannot do' },
    'agent:memory':{ name:'Memory Agent', role:'Maintains long-term and working memory for continuity' },
    'agent:policy':{ name:'Policy Agent', role:'Turns permissions, safety, and user boundaries into constraints' },
    'agent:attention':{ name:'Attention Agent', role:'Allocates priority and interruption budgets across goals' },
    'agent:asr-context':{ name:'ASR Context Agent', role:'Maintains names and domain terms for speech recognition' },
  },
  reasons:{
    model_route_missing:'Model route is missing', model_endpoint_missing:'Model endpoint is missing', model_endpoint_invalid:'Model endpoint is invalid',
    probe_unavailable:'Network probe unavailable', network_timeout:'Connection timed out', network_connect_failed:'Connection failed',
    network_request_failed:'Network request failed', model_probe_unavailable:'Model probe unavailable', missing_api_key:'Model API key missing',
    auth_failed:'Model authentication failed', mismatch:'Configured model mismatch', offline:'Model service offline', unverified:'Model not yet verified',
  },
  events:{
    runtime_started:'Runtime started', identity_declared:'Continuous identity ready', agent_registered:'Agent registered',
    mission_opened:'Goal opened', run_started:'Run started', resource_observed:'Resources observed',
    claim_asserted:'New claim formed', claim_retracted:'Claim retracted', directive_issued:'Directive issued',
    directive_acknowledged:'Directive acknowledged',
    connectivity_observed:'Connectivity updated', inference_health_observed:'Model health updated', inference_completed:'Inference succeeded',
    interaction_run_opened:'Interaction received', interaction_run_started:'Interaction started', interaction_tool_started:'Capability started',
    interaction_tool_finished:'Capability finished', interaction_assistant_message_completed:'Response completed', interaction_run_finished:'Interaction finished',
  },
} });
Object.assign(dict.ja, { uiPinvouOs: {
  identity:'Pinvou', continuous:'常時稼働', oneIdentity:'1つの対話画面 · 1つの連続した人格',
  canvasTitle:'対話キャンバス', canvasRuntimeSummary:'キャンバス実行状態', activeMissions:'進行中の目標',
  interactionStates:{ idle:'お話しください', submitted:'受信済み', running:'処理中', interrupted:'確認待ち', completed:'完了', cancelled:'キャンセル', failed:'未完了' },
  agentsLabel:'Agent', running:'稼働中', pressure:'リソース負荷',
  pressures:{ normal:'正常', warm:'やや高い', hot:'高負荷', critical:'危険' },
  cpu:'CPU', memory:'メモリ', temperature:'温度', agentRuntime:'Agent Runtime',
  network:'ネットワーク', model:'モデル', online:'オンライン', offline:'オフライン', degraded:'異常', unavailable:'利用不可', unknown:'不明',
  modelReady:'準備完了', modelUnknown:'未設定', lastCheck:'最終確認', lastSuccess:'最終成功',
  awaitingFirstSuccess:'初回成功を待機中', failureReason:'障害理由', none:'なし',
  runtimeHint:'常駐システム Agent とアトミック能力', refresh:'ランタイムを更新',
  bridgeUnavailable:'PinvouOS Runtime はデスクトップアプリで利用できます', readFailed:'PinvouOS Runtime の読み込みに失敗しました',
  eventFabric:'イベントネットワーク', sharedTruth:'共有ファクト台帳',
  influenceChain:'実動連鎖：リソース観測 → Claim → Governor → Agent 制御指示',
  openRuntime:'Agent Runtime を開く', closeRuntime:'Agent Runtime を閉じる',
  ready:'稼働中', paused:'一時停止', stopped:'停止', scaffold:'骨格',
  agents:{
    ...
    'agent:device':{ name:'デバイス Agent', role:'デバイス・周辺機器の事実を維持' },
    'agent:capability':{ name:'能力 Agent', role:'Pinvou が可能・一時不可・非対応のことを説明' },
    'agent:memory':{ name:'メモリ Agent', role:'連続性に必要な長期・作業メモリを維持' },
    'agent:policy':{ name:'ポリシー Agent', role:'権限・安全・ユーザー境界を制約へ変換' },
    'agent:attention':{ name:'注意力 Agent', role:'複数目標へ優先度と割り込み予算を配分' },
    'agent:asr-context':{ name:'ASR Context Agent', role:'音声認識向けの人名と専門用語を維持' },
  },
  reasons:{
    model_route_missing:'モデル経路がありません', model_endpoint_missing:'モデル接続先がありません', model_endpoint_invalid:'モデル接続先が無効です',
    probe_unavailable:'ネットワーク検査を利用できません', network_timeout:'接続がタイムアウトしました', network_connect_failed:'接続できません',
    network_request_failed:'ネットワーク要求に失敗しました', model_probe_unavailable:'モデル検査を利用できません', missing_api_key:'モデル API キーがありません',
    auth_failed:'モデル認証に失敗しました', mismatch:'モデル設定が一致しません', offline:'モデルサービスはオフラインです', unverified:'モデルは未検証です',
  },
  events:{
    runtime_started:'ランタイム起動', identity_declared:'連続人格を準備', agent_registered:'Agent 登録',
    mission_opened:'目標を作成', run_started:'実行開始', resource_observed:'リソース観測',
    claim_asserted:'新しい事実を形成', claim_retracted:'事実を撤回', directive_issued:'制御指示を発行',
    directive_acknowledged:'制御指示を確認',
    connectivity_observed:'接続状態を更新', inference_health_observed:'モデル状態を更新', inference_completed:'推論成功',
    interaction_run_opened:'対話を受信', interaction_run_started:'対話開始', interaction_tool_started:'能力呼び出し開始',
    interaction_tool_finished:'能力呼び出し終了', interaction_assistant_message_completed:'応答を作成', interaction_run_finished:'対話終了',
  },
} });
