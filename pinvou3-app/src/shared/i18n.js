...
const dict = {
      zh: {
        ...
        voiceIntroTaskTitle: '有文本时按 Alt',
        voiceIntroTaskDesc: '输入框已有内容时，按 Alt 可以说出修改要求，Pinvou 会编辑当前文本。',
        voiceIntroTaskSteps: ['输入框已有文本时按 Alt 开始录音', '再按 Alt 结束录音', '根据语音要求编辑当前文本，确认后可发送'],
        voiceIntroTaskExampleLabel: '示例编辑',
        voiceIntroTaskExample: '“把这段改成三条要点，语气更正式。”',
        voiceIntroTaskHint: '再次按 Alt 结束并编辑',
        voiceIntroGotIt: '暂不开启，继续语音',
        voiceIntroDone: '知道了',
        voiceIntroStart: '知道了，开始语音输入',
        voiceIntroEnable: '启用并继续',
        voiceShortcutEnableTitle: '启用快捷键唤醒语音',
        voiceShortcutEnableDesc: '开启后，Alt 可语音输入；输入框已有文本时可语音编辑当前文本。',
      ...
      en: {
        ...
        voiceIntroTaskTitle: 'Press Alt with text',
        voiceIntroTaskDesc: 'When the input box already has text, press Alt and say how to change it. Pinvou edits the current text.',
        voiceIntroTaskSteps: ['Press Alt when the input box has text', 'Press Alt again to stop recording', 'Review the edited text, then send it when ready'],
        ...
        voiceIntroTaskHint: 'Press Alt again to stop and edit',
        ...
        voiceShortcutEnableDesc: 'Alt starts voice input. When the input box already has text, Alt edits the current text.',
      ...
      ja: {
        ...
        uiSettings: { common:'一般', system:'システム', general:'一般', model:'モデル', search:'検索', memory:'メモリ', permissions:'権限と環境', data:'データ管理', update:'更新', help:'ヘルプとフィードバック', appearance:'外観', language:'表示言語', languageDesc:'アプリの表示言語を切り替えます', theme:'テーマ', themeDesc:'ライトまたはダーク外観を選択', notifications:'通知', taskNotice:'タスク完了通知', taskNoticeDesc:'タスク完了時にシステム通知を表示', voiceShortcuts:'音声ショートカット', voiceShortcutEnable:'Alt 音声ショートカットを有効化', voiceShortcutEnableDesc:'Alt で音声入力を開始します。入力欄にテキストがある場合は、Alt で現在のテキストを音声編集します。既定ではオフです。', voiceShortcutHelp:'Alt 音声ショートカットの説明を表示', desktopAssistant:'デスクトップアシスタント', pet:'デスクトップコンパニオン', petDesc:'デスクトップに常駐コンパニオンを表示', version:'バージョン', currentVersion:'現在のバージョン', beta:'ベータ版', releaseNotes:'更新内容', noReleaseNotes:'更新内容はありません', downloading:p=>`更新をダウンロード中 ${p}%`, installingUpdate:'更新をインストール中…', installerStarted:'インストーラー起動済み', cancelDownload:'ダウンロードをキャンセル', providers:'プロバイダー' },
        ...
        voiceIntroTaskTitle: 'テキストがある時に Alt',
        voiceIntroTaskDesc: '入力欄にテキストがある場合、Alt を押して変更内容を話すと、Pinvou が現在のテキストを編集します。',
        voiceIntroTaskSteps: ['入力欄にテキストがある時に Alt で録音開始', 'もう一度 Alt で録音終了', '編集後のテキストを確認して送信できます'],
        voiceIntroTaskExampleLabel: '編集例',
        voiceIntroTaskExample: '「これを3つの要点にして、少し丁寧な表現にして。」',
        voiceIntroTaskHint: 'もう一度 Alt で終了して編集',
        voiceIntroGotIt: '今は有効化せず続ける',
        voiceIntroDone: '了解',
        voiceIntroStart: '了解、音声入力を開始',
        voiceIntroEnable: '有効化して続ける',
        voiceShortcutEnableTitle: '音声ショートカットを有効化',
        voiceShortcutEnableDesc: 'Alt で音声入力を開始します。入力欄にテキストがある場合は、Alt で現在のテキストを音声編集します。',
