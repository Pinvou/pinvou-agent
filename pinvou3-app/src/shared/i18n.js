...
const dict = {
      zh: {
        ...
        uiMultiAgent: {
          ...
          agentsListTitle:'智能体', mainConversation:'主对话', coordinatorRole:'协调者',
          expandMainConversation:'展开主对话的子智能体', collapseMainConversation:'收起主对话的子智能体',
          agentsEmpty:'本会话还没有派出过子智能体。', backToAgents:'返回智能体列表',
      ...
      en: {
        ...
        uiMultiAgent: {
          ...
          agentsListTitle:'Agents', mainConversation:'Main conversation', coordinatorRole:'Coordinator',
          expandMainConversation:'Expand subagents of the main conversation', collapseMainConversation:'Collapse subagents of the main conversation',
          agentsEmpty:'No subagents have been dispatched in this conversation yet.', backToAgents:'Back to agent list',
      ...
      ja: {
        ...
        uiMultiAgent: {
          ...
          agentsListTitle:'エージェント', mainConversation:'メイン会話', coordinatorRole:'コーディネーター',
          expandMainConversation:'メイン会話のサブエージェントを展開', collapseMainConversation:'メイン会話のサブエージェントを折りたたむ',
          agentsEmpty:'この会話ではまだサブエージェントを派遣していません。', backToAgents:'エージェント一覧へ戻る',
