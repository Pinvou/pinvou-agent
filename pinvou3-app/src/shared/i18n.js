...
const acpProvidersZh = {
  ...
  deleteKeyConfirm:'清空 API Key 输入框将删除已保存的密钥，确定？',
...
const acpProvidersEn = {
  ...
  deleteKeyConfirm:'Clearing the API Key field will delete the saved key. Continue?',
...
const acpProvidersJa = {
  ...
  deleteKeyConfirm:'API Key 欄を空にすると保存済みのキーが削除されます。続行しますか？',
