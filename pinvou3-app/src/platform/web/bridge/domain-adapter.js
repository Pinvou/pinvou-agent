...
(function () {
  ...
  window.TauriBridge = {
    ...
    collaboration: domain(["refreshCollaborationConfig", "refreshCollaborationStatus", "collaborationStart", "collaborationRegisterIdentity", "collaborationCreateProject", "collaborationJoinProject", "collaborationExportMemberInvite", "collaborationCreateInvite", "collaborationInspectInvite", "collaborationJoinInvite", "collaborationCreateTask", "collaborationGetTaskContext", "collaborationCreateLocalTask", "collaborationListLocalTasks", "collaborationUpdateLocalTask", "collaborationCompleteLocalTask", "collaborationAcceptTask", "collaborationRejectTask", "openCollaborationMockSession", "openCollaborationTaskSession"]),
