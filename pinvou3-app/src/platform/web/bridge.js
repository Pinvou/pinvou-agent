...
function clearScheduledTaskDraft() { return pinvouSharedweb().clearScheduledTaskDraft(); }

async function confirmScheduledTaskDraft(editedDraft) { return pinvouSharedweb().confirmScheduledTaskDraft(editedDraft); }
