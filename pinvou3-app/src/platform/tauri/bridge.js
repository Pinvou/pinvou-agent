...
(function () {
  ...
  const BT_TABLE = {
    en: {
      ...
      memoryWriteFailed: "Memory write failed: ", memoryIgnoreFailed: "Failed to ignore memory: ", memoryNeverFailed: "Failed to set \"never ask\": ", memoryOrganizeFailed: "Failed to organize memory: ",
    ...
    ja: {
      ...
      memoryWriteFailed: "メモリの書き込みに失敗: ", memoryIgnoreFailed: "メモリの無視に失敗: ", memoryNeverFailed: "「今後表示しない」の設定に失敗: ", memoryOrganizeFailed: "メモリの整理に失敗: ",
    ...
    zh: {
      ...
      memoryWriteFailed: "记忆写入失败：", memoryIgnoreFailed: "忽略记忆失败：", memoryNeverFailed: "设置不再提示失败：", memoryOrganizeFailed: "记忆整理失败：",
