...
(function () {
  ...
  var BT_TABLE = {
    en: {
      ...
      voiceRecordingTooShort: "Recording is too short. Speak for at least 1 second, then try again.",
    ...
    ja: {
      ...
      voiceRecordingTooShort: "録音時間が短すぎます。1秒以上話してから再試行してください。",
    ...
    zh: {
      ...
      voiceRecordingTooShort: "录音时间太短，请至少说 1 秒后再重试。",
