...
dict.zh.uiSettingsDetail.llamaEngine = {
  ...
  setupSection: '安装与模型', behaviorSection: '行为',
  ...
  installEngine: '下载引擎（约 40MB）', installModel: '下载',
...
dict.en.uiSettingsDetail.llamaEngine = {
  ...
  setupSection: 'Setup & model', behaviorSection: 'Behavior',
  ...
  installEngine: 'Download engine (~40MB)', installModel: 'Download',
  gpu: 'GPU (Vulkan / Metal)', cpu: 'CPU',
  deviceAuto: 'Auto',
  ...
  autoStartNever: 'Never auto-start',
...
dict.ja.uiSettingsDetail.llamaEngine = {
  ...
  setupSection: 'インストールとモデル', behaviorSection: '動作',
  ...
  installEngine: 'エンジンをダウンロード（約 40MB）', installModel: 'ダウンロード',
  gpu: 'GPU（Vulkan / Metal）', cpu: 'CPU',
  deviceAuto: '自動',
