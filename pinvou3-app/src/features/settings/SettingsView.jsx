      ...
      cloud: [
        {
          ...
          items: [
            { model: 'glm-5-turbo', title: 'GLM-5-Turbo', desc: 'Coding Plan 推荐模型' },
            { model: 'glm-5.1', title: 'GLM-5.1', desc: 'Coding Plan 通用模型' },
            { model: 'glm-4.7', title: 'GLM-4.7', desc: 'Coding Plan 通用模型' },
            { model: 'glm-4.5-air', title: 'GLM-4.5-Air', desc: '轻量编码模型' },
            { model: 'glm-5v-turbo', title: 'GLM-5V-Turbo', desc: '支持视觉输入' },
        ...
        },
        {
          ...
          items: [
            { model: 'kimi-k2.7-code', title: 'kimi-k2.7-code', desc: 'Coding Plan 代码模型' },
            { model: 'kimi-k2.7-code-highspeed', title: 'kimi-k2.7-code-highspeed', desc: '高速代码模型' },
