...
const ClearStatsHold = ({ theme, t, onClear }) => {
    ...
    const MonitorView = ({ theme, t, bs }) => {
      ...
      return (
        <div className="flex-1 flex flex-col w-full h-full relative z-10 animate-in fade-in duration-300 p-4 sm:p-6 lg:p-10">

          <div
            className="w-full max-w-[1400px] mx-auto pb-6 flex items-center justify-between border-b"
            style={{ borderColor: isDark ? 'rgba(255,255,255,.10)' : 'rgba(198,198,200,.55)' }}
          >
            <div>
              <h1 className="text-[26px] font-normal tracking-tight">{t.sysStatus}</h1>
            </div>
