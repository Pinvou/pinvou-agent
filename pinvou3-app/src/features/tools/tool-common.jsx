...
const AcFmtIcon = FileTypeIcon;
    ...
    const getToolTypeGroup = (tool, bundleMcpIds) => {
      ...
      if (tool.oauthMcp || /mcp/i.test(tool.type || '')) return 'mcp';
      return 'api';
    };
