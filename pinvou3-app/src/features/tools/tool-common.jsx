...
const AcFmtIcon = ({ kind, className }) => {
      ...
      // material-icon-theme 全彩填充图形:fill 内嵌在 glyph 里,不再套描边包装
      return <svg viewBox={fmt.viewBox || '0 0 24 24'} className={className} dangerouslySetInnerHTML={{ __html: fmt.glyph }} />;
    };
