...
pub use linux_system::{
    ...
    command_exists, email_dependency_packages, email_manual_hint, email_tool_exists, gpu_class,
    libreoffice_missing_message, libreoffice_open_fallback_needed, libreoffice_tool_path,
    make_private_dir, msg_converter_required, msg_native_supported, nvidia_smi_candidates,
    ...
    presentation_pdf_missing_message, process_alive, reveal_target, show_archive_dependency_check,
