...
pub use path::{
    ...
    null_device, obsidian_config_path, path_component_eq, path_identity_is_same_or_nested,
    path_relative_suffix_under, platform_compat_path, python_command, user_home_dir,
