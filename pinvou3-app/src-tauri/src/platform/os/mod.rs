...
libreoffice_open_fallback_needed,
libreoffice_tool_path,
make_private_dir,
msg_converter_required,
...
ocr_tool_path,
open_target,
pandoc_dependency_packages,
pandoc_missing_message,
pandoc_tool_exists,
pandoc_tool_path,
path_component_eq,
pdf_dependency_packages,
pdf_ocr_missing_message,
pdf_render_missing_message,
pdf_text_missing_message,
pdf_tool_exists,
pdf_tool_path,
physical_core_count,
platform_compat_path,
presentation_pdf_missing_message,
process_alive,
python_command,
reveal_target,
show_archive_dependency_check,
show_ocr_dependency_check,
show_pandoc_dependency_check,
show_pdf_dependency_check,
spawn_detached_and_reap,
