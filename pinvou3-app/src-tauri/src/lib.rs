...
pub fn run() {
    ...
    let builder = tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::connectors::connector_ensure_cli,
            commands::connectors::connector_status,
            commands::connectors::connector_connect_begin,
            commands::connectors::connector_cancel,
            commands::connectors::connector_logout,
            commands::connectors::connector_apply_skills,
            commands::connectors::connector_set_enabled,
            commands::connectors::connector_skills_state,
            ...
            commands::marketplace::list_cli_bundles,
