...
pub fn run() {
    ...
    let builder = tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::connectors::weibo_ensure_cli,
            commands::connectors::weibo_status,
            commands::connectors::weibo_connect_begin,
            commands::connectors::weibo_cancel,
            commands::connectors::weibo_logout,
            commands::connectors::weibo_apply_skills,
            commands::connectors::set_weibo_enabled,
            commands::connectors::weibo_skills_state,
