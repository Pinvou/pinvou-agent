...
/// Heuristic guard against a caller truncating an unrelated existing
/// transcript. Returns `true` when the incoming message list is shorter than
/// the existing one and diverges on the first one or two messages.
