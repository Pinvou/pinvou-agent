//! Host filesystem browsing and Session artifact chunk reads surfaced over
//! the remote-control surface. These helpers are stateless and shared by the
//! Tauri command layer; they never touch `Inner`.
...
use super::{MAX_ARTIFACT_CHUNK_BYTES, MAX_HOST_ENTRIES};
use crate::features::remote_control::platform;
