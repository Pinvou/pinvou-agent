...
mod tests {
    ...
    fn migrates_legacy_projects_and_cleans_bindings() {
        ...
        std::fs::write(
            ...
            r#"{"s1":{"name":"legacy-ppt-workflow","phases":[],"project_dir":"/old/path"}}"#,
        )
        .unwrap();
    ...
    fn archives_host_with_user_messages_instead_of_deleting() {
        ...
        std::fs::write(
            crate::platform::paths::sessions_root().join("_skill_bindings.json"),
            r#"{"s2":{"name":"legacy-ppt-workflow","phases":[],"project_dir":"/old/p2"},"chat1":{"name":"deep-research","phases":[],"project_dir":null}}"#,
        )
        .unwrap();
    ...
    fn host_archive_failure_returns_err_and_resumes_from_pending_file() {
        ...
        std::fs::write(
            ...
            r#"{"s9":{"name":"legacy-ppt-workflow","phases":[],"project_dir":"/old/p9"}}"#,
        )
        .unwrap();
