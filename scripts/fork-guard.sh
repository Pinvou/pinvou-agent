...
fingerprints=(
  ...
  "APP|消息携带 resolved route            |pinvou3-app/src-tauri/src/app/bridge/mod.rs|resolve_runtime_route_for_model"
  "APP|部署级 route profile               |pinvou3-app/src-tauri/src/app/bridge/mod.rs|fn route_limits_for_model("
  "APP|128K/256K Compact 结果式回归       |pinvou3-app/src-tauri/src/app/bridge/mod.rs|fn forkguard_compaction_128k_scenarios"
