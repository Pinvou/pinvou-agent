#!/usr/bin/env bash
# CodeWhale v0.9.12 clean re-fork guard: 43 commits above v0.9.12, eight maintained themes (r2 closed at 6f780290f; gitlink tracks the open upstream #65 head).
set -uo pipefail
...
EXPECTED_HEAD="0576deb2c477910a255da2cf8f7066742c6ef8ae"
EXPECTED_COMMITS=43
...
bold "── 第 0 层：v0.9.12 clean re-fork 拓扑（r1 tag 之后 28 个提交＝24 个登记合入＋4 个 T8 待合并提交；r2 tag 已切在 6f780290f，gitlink 暂沿 #65 分支领先）──"
