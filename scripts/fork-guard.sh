...
fingerprints=(
  ...
  "APP|消息携带 resolved route            |pinvou3-app/src-tauri/src/platform/engine_bridge.rs|resolve_runtime_route_for_model"
  "APP|部署级 route profile               |pinvou3-app/src-tauri/src/platform/engine_bridge.rs|fn route_limits_for_model("
  "APP|128K/256K Compact 结果式回归       |pinvou3-app/src-tauri/src/platform/engine_bridge.rs|fn forkguard_compaction_128k_scenarios"
  "APP|兼容引擎显式 limits 结果式回归     |pinvou3-app/src-tauri/src/platform/engine_bridge.rs|fn forkguard_openai_compatible_route_uses_declared_limits"
  ...
  "APP|静态层 composer 仍由 app 安装      |pinvou3-app/src-tauri/src/platform/bundle.rs|set_static_prompt_composer_override"
  "APP|内置技能写入 bundle 单一来源        |pinvou3-app/src-tauri/src/platform/bundle.rs|fn forkguard_builtin_visual_skill_uses_bundle_root_and_safe_name"
  ...
  "APP|后台终态输出 tail 对账             |pinvou3-app/src/platform/tauri/bridge.js|function reconcileBackgroundTerminalOutput(previous, payload)"
